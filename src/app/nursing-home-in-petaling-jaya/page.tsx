...
export const metadata: Metadata = {
  ...
  description:
    'Genesis Life Care PJ — flagship nursing home with a memory-care wing, rehab & 24/7 nursing. From RM 2,500/mo. Rated 4.9★ on Google. Book a free tour.',
  alternates: {
...
export default function NursingHomePJ() {
  ...
  return (
    <>
      ...
      {/* ── BOTTOM CTA ────────────────────────────────────────────────── */}
      <CentreTour lang="en" centre="Petaling Jaya" video="/videos/pj-tour.mp4" poster="/images/pj-centre.jpg" />
