      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            '@id': 'https://genesiscare.com.my/old-folks-home-in-puchong',
            ...
            url: 'https://genesiscare.com.my/old-folks-home-in-puchong',
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="hidden lg:block">
              <div className="relative">
                <img src={centre.heroImg} alt={`${centre.fullName} — old folks home in Puchong`} className="rounded-2xl shadow-2xl w-full object-cover" style={{ maxHeight: '420px' }} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-6">
                Why Choose Our Old Folks Home in Puchong?
              </h2>
              ...
              <div className="flex flex-wrap gap-2 mt-6">
                {['Modern Facility', 'Quality Dining', 'LDP & ELITE Access', 'Bandar Puteri', 'Near Hospitals'].map((t) => (
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              Beyond everyday care, our old folks home in Puchong offers a full range of specialist services.
            </p>
          </div>
