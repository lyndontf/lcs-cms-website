  ...
  '@graph': [
    {
      ...
      url: 'https://genesiscare.com.my/stroke-rehabilitation-in-kajang',
...
export default function StrokeRehabKajang() {
  return (
    <main className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
              Expert Stroke Recovery Services in Kajang
            </h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                Stroke recovery is a journey that requires dedicated, professional support from
              ...
              <p>
                Our multidisciplinary approach brings together physiotherapy to rebuild strength
              ...
              <p>
                Our Kajang centre at Reko Sentral serves families from Kajang, Bangi, Semenyih,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              A comprehensive, multidisciplinary approach to stroke recovery at our Kajang centre.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              Care Services at Our Kajang Centre
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              Serving the southern Klang Valley with dedicated stroke rehabilitation facilities.
            </p>
          </div>
      ...
      <FinalCtaSection heading="Start Your Stroke Recovery Journey in Kajang" description="Visit our Kajang centre for a free consultation. Meet our rehabilitation team and discover how we can help your loved one recover from stroke." centre={centre} />
    </main>
  );
}
