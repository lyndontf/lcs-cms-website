        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="bg-gradient-to-br from-[#2E72B8] to-[#09B7D3] p-8 sm:p-12 flex flex-col justify-center text-white">
                <h3 className="text-xl font-bold mb-4">Available Programmes</h3>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={prog.title} className="bg-white/10 rounded-lg p-4 border border-white/10">
                      <div className="flex items-center justify-between mb-1">
                        ...
                        <span className="text-xs text-white/70">{prog.duration}</span>
                      </div>
                      <p className="text-xs text-white/80">{prog.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
