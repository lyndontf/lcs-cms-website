...
const centre = {
  ...
  beds: '120+',
  mapEmbed:
    'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.5!2d101.6175!3d3.0245!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc4f8f8f8f8f8f%3A0x8f8f8f8f8f8f8f8f!2sGenesis+Life+Care+Puchong!5e0!3m2!1sen!2smy!4v1700000000000',
...
const teamMembers = [
  ...
  },
  {
    name: 'Jenny',
    role: 'Centre Manager',
    bio: 'Manages daily operations at the Puchong centre, ensuring a welcoming and efficient environment for all residents.',
...
const testimonials = [
  {
    name: 'Sarah Tan',
    text: 'The Puchong centre is very clean and well-maintained. The staff are always friendly and attentive to my father\'s needs. Very thankful we found Genesis.',
    rating: 5,
  },
  {
    name: 'Ahmad Razak',
    text: 'Modern facilities and caring staff. My mother has been here for 3 months and she is happy with the food and activities. Convenient location too.',
    rating: 5,
  },
  {
    name: 'Michelle Lim',
    text: 'Great experience with the post-op recovery programme. The therapists are professional and my dad recovered faster than expected.',
    rating: 4,
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{color: 'white'}}>
                A modern nursing home in the heart of Bandar Puteri with convenient
                highway access. Full-service elderly care including rehabilitation,
                dementia programmes, and Senior Daycare — all in a contemporary,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
                Modern Care in the Heart<br />of Bandar Puteri
              </h2>
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Genesis Life Care Puchong is our modern facility located in the thriving
                  township of Bandar Puteri. With easy access via the LDP and ELITE highways,
                  families across the Klang Valley can visit their loved ones conveniently.
                </p>
                <p>
                  The centre features purpose-designed spaces for rehabilitation, memory care,
                  and daily activities — all built to the latest care standards. Our open-plan
                  common areas encourage social interaction and a sense of community among residents.
                </p>
                <p>
                  Our care team provides round-the-clock nursing support, weekly doctor consultations,
                  and personalised care plans tailored to each resident&apos;s unique needs and preferences.
                </p>
              </div>

              <div className="flex flex-wrap gap-3 mt-8">
                {['Highway Access', 'Modern Design', 'Dementia Care', '24/7 Nursing', 'Rehab Services', 'Quality Dining'].map((tag) => (
            ...
            <div className="relative">
              <img
                src="/images/puchong-centre.jpeg"
                alt="Genesis Life Care Puchong building"
                className="rounded-2xl shadow-lg w-full h-[400px] object-cover"
              />
              <div className="bed-badge absolute -bottom-5 -right-5 bg-secondary text-white text-center rounded-xl px-6 py-4 shadow-lg hidden sm:block">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              Care Services at Puchong Centre
            </h2>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              Our Puchong centre is designed for comfort, safety, and a home-like atmosphere.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-3">Not in Puchong? We have 4 more locations across Malaysia.</p>
          </div>
