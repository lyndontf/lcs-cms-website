      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            '@id': 'https://genesiscare.com.my/old-folks-home-in-johor-bahru',
            ...
            url: 'https://genesiscare.com.my/old-folks-home-in-johor-bahru',
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2">Why Johor Bahru</p>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-6">
                Why Choose Our Old Folks Home in Johor Bahru?
              </h2>
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Genesis Life Care Johor Bahru is our first centre outside the Klang Valley, bringing the same
                  trusted care standards that families across Malaysia have come to rely on to the southern region.
                  Located at Holiday Plaza on Jalan Dato Sulaiman, a well-known landmark in central Johor Bahru,
                  our centre is purpose-built to provide the highest standard of elderly care.
                </p>
                <p>
                  We serve families across JB, Iskandar Malaysia, Skudai, Kulai, and surrounding areas. Our centre
                  is conveniently located near Hospital Sultanah Aminah and other major Johor Bahru healthcare
                  facilities, ensuring quick access to specialist medical support when needed.
                </p>
                <p>
                  Our JB old folks home also serves Malaysian families from Singapore who want their elderly parents
                  cared for nearby. With a full range of specialist care including dementia programmes, rehabilitation
                  services, and nutritious meals, residents receive comprehensive, personalised care
                  under one roof.
                </p>
              </div>
              <div className="flex flex-wrap gap-2 mt-6">
                {['Southern Region', 'Holiday Plaza', 'Near HSA Hospital', 'Serves JB & Iskandar', 'Quality Dining'].map((t) => (
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              Beyond everyday care, our old folks home in Johor Bahru offers a full range of specialist services.
            </p>
          </div>
