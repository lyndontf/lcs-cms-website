        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
              Expert Stroke Recovery Services in Klang
            </h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                Recovering from a stroke requires specialised, consistent rehabilitation from a
              ...
              <p>
                Genesis Life Care Klang is our original centre, located at Amverton Business Centre
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              A comprehensive, multidisciplinary approach to stroke recovery at our Klang centre.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              Care Services at Our Klang Centre
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              Our original centre in Klang with dedicated stroke rehabilitation facilities.
            </p>
          </div>
