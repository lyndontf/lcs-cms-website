...
export default function NursingHomeJB() {
  ...
  return (
    <>
      ...
      <FaqSection
        faqs={[
          { q: 'How much does nursing care cost at the Johor Bahru centre?', a: 'Our JB centre offers comprehensive care starting from RM 2,500/month. We provide flexible payment packages and room types to suit different care needs and budgets.' },
          { q: 'Where is the Genesis Life Care Johor Bahru centre located?', a: 'We are located in Johor Bahru, serving the southern region with a modern facility designed for elderly care. The centre is easily accessible from major highways across Johor and Selangor.' },
          { q: 'What makes the JB centre special?', a: 'As our southern region centre, JB serves families across Johor and neighboring states. We maintain the same high standards as all Genesis Life Care centres with a dedicated local care team rated 4.8 stars.' },
          { q: 'What care services are provided at the JB centre?', a: 'We offer 24/7 nursing care, dementia & memory care, stroke rehabilitation, palliative care, post-op recovery, and Senior Daycare programmes. All services are tailored to individual resident needs.' },
          { q: 'Can I schedule a tour of the Johor Bahru centre?', a: 'Yes! Call us at +6019-282-0457 or submit an online inquiry. Tours are available daily from 9:00 AM to 6:00 PM. We recommend booking in advance.' },
        ]}
      ...
      {/* ── FINAL CTA ────────────────────────────────────────────────── */}
      <FinalCtaSection
        heading="Ready to Visit Our Johor Bahru Centre?"
        description="Book a free tour of our Johor Bahru facility. See our care spaces, meet the team, and learn about our programmes — no obligations."
