          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <h1 className="text-4xl sm:text-5xl font-extrabold leading-[1.1] tracking-tight text-white mb-5" style={{ color: 'white' }}>
                Dementia Care in<br />Petaling Jaya
              </h1>
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                Genesis Life Care PJ provides specialised dementia and memory care with
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg px-5 py-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Petaling Jaya</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2">Dementia Care in Petaling Jaya</p>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                ...
                ability to perform everyday activities. In Malaysia, the number of people
                living with dementia is rising as the population ages, and many families
                in Petaling Jaya are seeking professional support for their loved ones.
              </p>
              <p>
              ...
              <p>
                At Genesis Life Care Petaling Jaya, our approach to dementia care is led by
                qualified psychologists who design structured cognitive stimulation programmes.
                Combined with 24-hour nursing care, on-site doctor consultations, and a
                safe environment, we help residents maintain their dignity, independence, and
                quality of life for as long as possible. Learn more about our{' '}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              A comprehensive, psychologist-led approach to dementia care at our Petaling Jaya centre.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              All Services at Our Petaling Jaya Centre
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              Our flagship centre in Kota Damansara — specialised dementia care in PJ.
            </p>
          </div>
