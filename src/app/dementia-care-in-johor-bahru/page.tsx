        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2" style={{ color: 'white' }}>Dementia Care in Johor Bahru</p>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2">Dementia Care in Johor Bahru</p>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                ...
                more families in Johor Bahru, Iskandar Puteri, Skudai, and across Johor
              ...
              <p>
                At Genesis Life Care Johor Bahru, our approach to dementia care is led by
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">A comprehensive, psychologist-led approach to dementia care at our Johor Bahru centre.</p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">All Services at Our Johor Bahru Centre</h2>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">Visit Our Johor Bahru Centre</h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">Serving families across Johor — specialised dementia care in JB.</p>
          </div>
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-8">
                <div className="flex items-center gap-2 mb-3">
                  <span className="bg-gold text-gray-900 text-xs font-bold px-3 py-1 rounded-full">Johor Centre</span>
