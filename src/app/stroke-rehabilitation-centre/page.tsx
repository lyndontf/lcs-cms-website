  ...
  return (
    <main className="bg-white">
      ...
      <FinalCtaSection
        ...
        description="Book a free consultation with our rehabilitation team. Visit any of our centres, meet the therapists, and learn about our stroke recovery programmes — no obligations."
      />
    </main>
  );
}
