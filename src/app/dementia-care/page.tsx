...
export default function DementiaCare() {
  return (
    <main className="bg-white">
      ...
      {/* ── FINAL CTA ────────────────────────────────────────────────── */}
      <FinalCtaSection
        heading="Find the Right Dementia Care for Your Loved One"
        description="Book a free consultation with our care advisors. Visit any of our centres, meet the team, and learn about our memory care programmes — no obligations."
      />
    </main>
  );
}
