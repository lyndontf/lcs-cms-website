...
export const metadata: Metadata = {
  title: "武吉加里尔附近的老年护理",
  description:
    '寻找武吉加里尔附近的老年护理？Genesis Life Care 巴生谷中心距离仅需约15分钟车程 — 提供24/7护理、失智症护理计划、中风康复和驻院医生。评分4.8★。预约免费参观。',
  openGraph: {
    title: '武吉加里尔附近的老年护理 - Genesis Life Care',
    description:
      '武吉加里尔附近的专业老年护理。24/7护理、失智症护理、中风康复。参访我们的巴生谷中心 — 距离武吉加里尔仅需几分钟。',
...
const faqs = [
  {
    q: '武吉加里尔附近有养老院吗？',
    a: '有。Genesis Life Care 巴生谷中心位于 Taman Perindustrian Puchong，距离武吉加里尔约15分钟车程。我们提供24/7护理、失智症护理计划和中风康复服务。',
  },
  {
    q: '武吉加里尔附近的老年护理费用是多少？',
  ...
  {
    q: '怎样从武吉加里尔前往 Genesis Life Care 巴生谷？',
    a: '我们巴生谷中心可通过 LDP（Lebuhraya Damansara-Puchong）或 Bukit Jalil 高速公路从武吉加里尔轻松到达。车程通常约15分钟。中心位于 Taman Perindustrian Puchong。',
  },
  {
    q: '与武吉加里尔附近的其他养老院相比，Genesis Life Care 有什么不同？',
  ...
  '@graph': [
    {
      ...
      description: 'Genesis Life Care 武吉加里尔附近的专业老年护理和养老院。',
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                武吉加里尔的家庭相信 Genesis Life Care 提供的优质养老院服务。我们的巴生谷中心距离仅需{nearestCentre.distance}车程 — 提供24/7护理、驻院医生咨询、失智症护理和综合康复。
              </p>
            ...
            <div className="relative hidden lg:block">
              <div className="rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
                <img src={nearestCentre.img} alt="Genesis Life Care 巴生谷中心 — 武吉加里尔附近的老年护理" className="w-full h-[420px] object-cover" />
              </div>
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg px-5 py-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">距离武吉加里尔</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2">武吉加里尔附近的老年护理</p>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
              为武吉加里尔家庭提供优质养老院服务
            </h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                武吉加里尔是吉隆坡南部一个快速发展的居住区，以其现代发展和家庭友善的环境而闻名。随着父母和祖父母年岁增长，为武吉加里尔居民寻找靠近家园的可靠且专业的老年护理成为首要优先事项。
              </p>
              <p>
                Genesis Life Care 巴生谷中心是距离武吉加里尔最近的 Genesis 中心 — 位于 Taman Perindustrian Puchong，可通过 LDP 或 Bukit Jalil 高速公路方便前往。我们的设施提供24小时护理、每周驻院医生咨询、心理学家主导的失智症计划和完整的康复部门，包括物理治疗和职业治疗。
              </p>
              <p>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              距离武吉加里尔仅需{nearestCentre.distance} — 我们位于 Taman Perindustrian Puchong 的中心。
            </p>
          </div>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          ...
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto" style={{ color: 'white' }}>
            参访我们的巴生谷中心进行免费参观。查看我们的护理空间、与团队见面，并了解为什么武吉加里尔的家庭相信 Genesis Life Care。
          </p>
