...
export const metadata: Metadata = {
  title: "柔佛州新山失智症护理",
  description:
    '新山专业失智症护理。心理学家主导的记忆护理计划、认知刺激、安全环境和个性化护理计划。评分 4.8★。在 Genesis Life Care 新山预约免费参观。',
  openGraph: {
    title: '柔佛州新山失智症护理 - Genesis Life Care',
    description:
      '新山专业失智症和记忆护理。心理学家主导的计划、24/7 护理、安全可靠的环境。预约免费参观。',
    images: [{ url: '/images/jb-centre.jpeg', width: 1200, height: 630, alt: 'Genesis Life Care 新山 — 失智症护理中心' }],
  },
};
...
const faqs = [
  {
    q: 'Genesis Life Care 新山提供哪些失智症护理服务？',
    a: '我们的新山中心提供全面的失智症护理，包括心理学家主导的认知刺激疗法、结构化日常活动、艺术和音乐治疗、具有跌倒预防措施的安全环保，以及根据每位住户失智症阶段量身定制的个性化护理计划。',
  },
  {
    q: 'Genesis Life Care 如何对待新山的失智症护理？',
    a: 'Genesis Life Care 在我们的新山中心采用心理学家主导的失智症护理方法。我们的计划由合格的心理学家设计和监督，他们创建结构化的认知刺激活动。结合 24/7 护理和在地医生咨询，我们提供全面的失智症支持。',
  },
  {
    q: '我应该注意哪些早期失智症迹象？',
  ...
  {
    q: '新山中心对失智症患者是否安全？',
    a: '是的。我们的新山中心在设计时就考虑了失智症的安全性。我们有安全的场所防止走失、整个设施都有跌倒预防措施、经训练的护理人员进行 24 小时监督，以及安全的结构化环境，帮助住户感到安心和定向。',
  },
  {
    q: '在新山的失智症护理费用是多少？',
    a: 'Genesis Life Care 在我们的新山中心提供经济实惠的失智症护理费用。费用因所需护理水平和房间类型而异。请联系我们获取个性化报价 — 我们很高兴讨论适合您家庭需求和预算的选项。',
  },
  {
    q: 'Genesis Life Care 为柔佛州的哪些地区提供失智症护理服务？',
    a: '我们的新山中心为柔佛州各地的家庭提供服务，包括新山市、伊斯干达布蒂亚、士古来、库拉、巴西古当、马赛和周围地区。我们位置便利，位于丹那地士古来，靠近高速公路。',
  },
];
...
export default function DementiaCareJBZh() {
  return (
    <main className="bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                Genesis Life Care 新山提供专业失智症和记忆护理，
                采用心理学家主导的计划、24/7 护理监督和安全、结构化的环境 —
                服务于整个新山、伊斯干达布蒂亚、士古来和周围地区的家庭。
              </p>
            ...
            <div className="relative hidden lg:block">
              <div className="rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
                <img src={centre.img} alt="Genesis Life Care 新山 — 失智症护理中心" className="w-full h-[420px] object-cover" />
              </div>
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg px-5 py-3 flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-gray-800">丹那地士古来</p>
                  <p className="text-xs text-gray-500">新山，柔佛州</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2">新山失智症护理</p>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                ...
                越来越多的新山、伊斯干达布蒂亚、士古来和柔佛州各地的家庭正在为他们的亲人寻求专业失智症护理。
              </p>
              <p>
              ...
              <p>
                在 Genesis Life Care 新山，我们的失智症护理方法由合格的心理学家主导，他们设计结构化的认知刺激计划。
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">在我们新山中心采用全面的、心理学家主导的失智症护理方法。</p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">我们新山中心的所有服务</h2>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">访问我们的新山中心</h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">为新山各地提供服务 — 新山专业失智症护理。</p>
          </div>
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-8">
                <div className="flex items-center gap-2 mb-3">
                  <span className="bg-gold text-gray-900 text-xs font-bold px-3 py-1 rounded-full">新山中心</span>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">关于新山失智症护理的常见问题。</p>
          </div>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">新山专业失智症护理</h2>
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto" style={{ color: 'white' }}>
            访问我们的新山中心进行免费参观。查看我们的失智症护理空间、
            与心理学家和护理团队见面，了解我们如何支持失智症患者的家庭。
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/zh/booking" className="inline-flex items-center gap-2 bg-gold text-gray-900 font-bold px-6 py-4 rounded-xl hover:bg-yellow-400 transition-colors whitespace-nowrap">
