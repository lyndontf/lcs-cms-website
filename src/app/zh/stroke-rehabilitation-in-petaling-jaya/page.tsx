...
export const metadata: Metadata = {
  title: '八打灵再也中风康复 | 创世纪生命护理',
  description:
    '八打灵再也专业中风康复。物理治疗、职业治疗和言语治疗。创世纪生命护理八打灵再也中心的个性化康复计划。评分4.7★。预约免费咨询。',
  openGraph: {
    title: '八打灵再也中风康复 - 创世纪生命护理',
    description:
      '八打灵再也全面的中风康复。物理治疗、职业治疗、言语治疗和个性化康复计划。访问我们的八打灵再也中心。',
    images: [{ url: '/images/pj-centre.jpg', width: 1200, height: 630, alt: '创世纪生命护理八打灵再也' }],
  },
};
...
const faqs = [
  {
    q: '八打灵再也有哪些中风康复服务？',
    a: '创世纪生命护理八打灵再也中心提供全面的中风康复，包括物理治疗、职业治疗和言语治疗。我们的多学科团队为中风幸存者设计个性化的康复计划，帮助他们恢复活动能力、独立性和沟通技能。',
  },
  {
    q: '中风后应该多快开始康复？',
    a: '中风后应尽快开始康复，通常在医学稳定后24至48小时内。早期康复已被证明能显著改善恢复效果。我们的团队与八打灵再也和万谷地区的医院紧密合作，确保无缝转入我们的康复计划。',
  },
  {
    q: '八打灵再也创世纪生命护理的中风康复需要多长时间？',
    a: '中风康复的时间长度取决于中风的严重程度和个人康复进展。有些患者在数周内会看到明显改善，而其他患者可能需要数个月的治疗。我们为每位患者设定个性化的里程碑，并定期重新评估计划。',
  },
  {
    q: '八打灵再也创世纪生命护理是否提供中风患者的言语治疗？',
    a: '是的，我们的八打灵再也中心提供言语和语言治疗，作为中风康复计划的一部分。这包括治疗失语症等沟通困难，以及吞咽困难患者的吞咽治疗。',
  },
  {
    q: '八打灵再也的中风康复费用是多少？',
  ...
  '@graph': [
    {
      ...
      name: '创世纪生命护理八打灵再也',
      description: '八打灵再也专业中风康复中心，提供物理治疗、职业治疗和言语治疗，支持中风恢复。',
      image: centre.img,
...
export default function StrokeRehabilitationPetalingJayaZh() {
  return (
      ...
      <section className="hero-dark relative bg-gradient-to-br from-primary via-primary-400 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <p className="text-gold text-sm font-bold uppercase tracking-widest mb-4">八打灵再也中风康复</p>
              ...
              <p className="text-lg text-white/90 max-w-xl mb-8 leading-relaxed" style={{ color: 'rgba(255,255,255,0.9)' }}>
                创世纪生命护理八打灵再也中心提供全面的物理治疗、职业治疗和言语治疗。专业的多学科团队为您亲人的中风恢复提供支持。
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-6">八打灵再也中风康复中心</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
                中风是一种医学突发事件，需要立即干预和快速的康复支持。在创世纪生命护理八打灵再也中心，我们从第一天就开始帮助中风患者走上恢复之路。在八打灵再也及中部吉隆坡地区，创世纪生命护理为每位患者提供一个结构化的中风康复计划，以最大化恢复潜力。
              </p>
              <p className="text-gray-600 leading-relaxed mb-4">
                我们的多学科方法汇集了物理治疗以恢复力量和协调、职业治疗以帮助患者在日常活动中恢复信心，以及言语治疗为那些受沟通或吞咽困难影响的患者提供服务。每位患者都会获得个性化的恢复计划，其中有明确的里程碑由我们的护理团队定期审查。
              </p>
              <p className="text-gray-600 leading-relaxed mb-6">
                我们位于Reko Sentral的八打灵再也中心服务来自八打灵再也、梳邦、蒙地亚莎及周边地区的家人。拥有{centre.beds}张床位和全天候护理，我们为中风恢复提供舒适和支持的环境。创世纪生命护理八打灵再也在谷歌上评分{centre.rating}星，拥有{centre.reviews}条来自信任我们照顾其亲人的家人的评价。
              </p>
            </div>
            <div>
              <img
