...
export const metadata: Metadata = {
  title: '八打灵再也中风康复',
  description:
    '创世生命关怀八打灵再也中心提供专业中风康复：物理治疗、职业治疗与言语治疗，由多学科团队量身定制康复计划，全天候护理支持，助力中风后恢复。预约免费咨询。',
  openGraph: {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                我们的八打灵再也中心服务来自八打灵再也、梳邦、蒙地亚莎及周边地区的家人。拥有{centre.beds}张床位和全天候护理，我们为中风恢复提供舒适和支持的环境。创世纪生命护理八打灵再也在谷歌上评分{centre.rating}星，拥有{centre.reviews}条来自信任我们照顾其亲人的家人的评价。
              </p>
            </div>
            <div>
              <img
