...
const checklist = [
  ...
  { title: '位置与便利性', desc: '我们的巴生中心通过联邦道路2号（巴生-沙亚南）和NKVE轻松抵达，访客停车充足。' },
...
const faqs = [
  {
    q: '巴生老人院需要多少费用?',
    a: 'Genesis Life Care巴生的费用因所需护理水平和房间类型而异。我们在巴生地区提供具有竞争力的费率，基本护理起价约为每月RM 2,500。请与我们联系，获取基于您亲人需求的个性化报价。',
  },
  {
    q: '老人院和护理院有什么区别?',
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-lg text-white/90 max-w-xl mb-8 leading-relaxed" style={{ color: 'rgba(255,255,255,0.9)' }}>
                Genesis Life Care的原创中心，成立于2018年。我们巴生家园提供超过七年的可信老年护理，配有24/7护理、失智症支持、康复设施和专门的内部厨房——全部在温暖、家庭式的环境中。
              </p>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2">为什么选择巴生</p>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-6">
                Why Choose Our 巴生老人院?
              </h2>
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  为亲人找到合适的老人院是家族能做出的最重要的决定之一。我们的巴生中心是Genesis Life Care的原创家园，成立于2018年——使其成为五个中心中经验最丰富的。位于Jalan Istana上的Amverton商业中心，是巴生城镇中心的一个著名地区，一直以来是全区家族的信任选择。
                </p>
                <p>
                  巴生是寻求经过验证的、社区根植老年护理的家族的理想选择。我们的中心靠近Tengku Ampuan Rahimah医院（HTAR），巴生主要的政府医院，通过联邦道路2号（巴生-沙亚南）和NKVE易于抵达，使家族访问无压力。
                </p>
                <p>
                  我们巴生老人院的独特之处在于熟悉的社区感——许多长期居民和他们的家族在多年来与我们的护理团队建立了密切的关系。凭借七年多的经验，我们的员工提供全天候护理、康复服务和高质量内部餐饮，具有仅来自原创中心的信心。
                </p>
              </div>
              <div className="flex flex-wrap gap-2 mt-6">
                {['创始中心', '靠近HTAR', '成立于2018', '120+床位', '优质餐饮'].map((t) => (
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 py-16 sm:py-20 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-xl mx-auto" style={{ color: 'rgba(255,255,255,0.9)' }}>
            预约我们巴生中心的免费参观。见见团队，参观设施，了解我们是否是您亲人的合适家园。无承诺。
          </p>
