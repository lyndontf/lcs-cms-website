...
const centre = {
  ...
  nursingHomeSlug: '/zh/nursing-home-in-klang',
  lat: 3.0456,
  lng: 101.4484,
};

const highlights = [
  { label: '服务年限', value: '7+', sub: 'Since 2018' },
...
const checklist = [
  ...
  { title: '位置与便利性', desc: 'Our Klang centre is easily accessible from Federal Route 2 (Klang-Shah Alam) and the NKVE, with ample parking for visitors.' },
  { title: '可用的专科护理', desc: '除了基本护理，我们提供失智症计划、中风康复、临终关怀和术后康复。' },
];

const faqs = [
  {
    q: 'How much does an old folks home cost 在巴生?',
...
export default function OldFolksHomeZh() {
  return (
    <main className="bg-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'LocalBusiness',
            '@id': 'https://genesiscare.com.my/zh/old-folks-home-in-klang',
            name: centre.fullName,
            description: 'Trusted old folks home 在巴生 with 24/7 nursing care, dementia care, rehabilitation and nutritious meals.',
            url: 'https://genesiscare.com.my/zh/old-folks-home-in-klang',
      ...
      {/* ── HERO ──────────────────────────────────────────────────────── */}
      <section
        className="hero-dark relative overflow-hidden bg-cover bg-center"
        style={{
          backgroundImage: `linear-gradient(135deg, rgba(46, 114, 184, 0.85) 0%, rgba(9, 183, 211, 0.75) 100%), url('${centre.heroImg}')`,
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 sm:py-24">
          <div className="grid lg:grid-cols-1 gap-10 items-center">
            ...
            <div className="lg:col-span-2 hidden lg:block">
              <HeroEnquiryForm centreName="巴生" pageUrl="/zh/old-folks-home-in-klang" lang="zh" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 text-center items-center">
            <div>
              ...
              <span className="block text-xs font-semibold text-gray-600 mt-1 uppercase">Residents Cared</span>
            </div>
            <div>
              <span className="block text-3xl sm:text-4xl font-extrabold text-primary">5</span>
              <span className="block text-xs font-semibold text-gray-600 mt-1 uppercase">Centres</span>
            </div>
            <div>
              <span className="block text-3xl sm:text-4xl font-extrabold text-primary">24/7</span>
              <span className="block text-xs font-semibold text-gray-600 mt-1 uppercase">Nursing Care</span>
            </div>
            <div>
              <span className="block text-3xl sm:text-4xl font-extrabold text-primary">{centre.rating} ★</span>
              <span className="block text-xs font-semibold text-gray-600 mt-1 uppercase">Google Rating</span>
            </div>
            <div className="flex flex-col items-center gap-2">
              <div className="flex gap-3">
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: '#2E72B8' }}>
                  <text x="2" y="18" fontSize="12" fontWeight="bold" fill="currentColor">JKM</text>
                </svg>
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor" style={{ color: '#2E72B8' }}>
                  <text x="2" y="18" fontSize="8" fontWeight="bold" fill="currentColor">AgeCope</text>
                </svg>
              </div>
              <span className="block text-xs font-semibold text-gray-600 uppercase">Certified</span>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                ...
                <p>
                  ...
                  在巴生, and is easily accessible from Federal Route 2 (Klang-Shah Alam) and the NKVE, making
              ...
              <div className="flex flex-wrap gap-2 mt-6">
                {['创始中心', 'Near HTAR', 'Est. 2018', '120+ Beds', '优质餐饮'].map((t) => (
            ...
            <div>
              <img
                ...
                alt="Common area at our old folks home 在巴生"
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              Beyond everyday care, our old folks home 在巴生 offers a full range of specialist services.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-[#f4f8fb]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed mb-8 text-center max-w-3xl mx-auto">          Choosing an old folks home is a big decision. Here is a simple checklist of what to look for — and how Genesis Life Care measures up.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              { step: '2', title: '免费评估与参观', desc: '访问我们的 Klang centre, meet the care team, and we will assess your loved one\'s needs at no charge.' },
