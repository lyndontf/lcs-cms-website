...
const checklist = [
  ...
  { title: '位置与便利性', desc: 'Our PJ centre is easily accessible via Federal Highway and LDP, with ample parking for visitors.' },
  { title: '可用的专科护理', desc: '除了基本护理，我们提供失智症计划、中风康复、临终关怀和术后康复。' },
];

const faqs = [
  {
    q: 'How much does an old folks home cost 在八打灵再也?',
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="hidden lg:block">
              <div className="relative">
                <img src={centre.heroImg} alt={`${centre.fullName} — old folks home 在八打灵再也`} className="rounded-2xl shadow-2xl w-full object-cover" style={{ maxHeight: '420px' }} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-6">
                {['Near Major Hospitals', 'Federal Highway Access', 'LDP Expressway', 'Memory Care Wing', '优质餐饮'].map((t) => (
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              Beyond everyday care, our old folks home 在八打灵再也 offers a full range of specialist services.
            </p>
          </div>
