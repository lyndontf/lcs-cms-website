    ...
    <main className="bg-white">
      ...
      <section className="hero-dark relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(135deg, rgba(46, 114, 184, 0.85) 0%, rgba(9, 183, 211, 0.85) 100%), url('${centre.heroImg}')`,
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6 text-center items-center">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <span className="block text-xs font-semibold text-gray-600 mt-2">JKM + AgeCope</span>
            </div>
          </div>
        </div>
      </section>
