  ...
  '@graph': [
    {
      ...
      url: 'https://genesiscare.com.my/zh/nursing-home-kajang',
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-5xl mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-8">
            <span className="text-secondary text-xs font-bold tracking-wide uppercase">虚拟导览</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mt-2 mb-3">走进我们的加影中心</h2>
            <p className="text-lg text-gray-600">没有摆拍照片 —— 真实走访长者即将入住的实际中心。</p>
          </div>
