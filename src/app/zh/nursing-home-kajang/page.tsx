            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                {[
                  {
                    q: '加影养老院护理费用是多少？',
                    a: 'Genesis Life Care 加影中心提供实惠的养老院套餐，起价 RM 2,500/月。费率根据房间类型和所需护理等级而有所不同。所有价格透明，无隐藏费用。使用我们的在线费用计算器或联系我们获取个性化报价。',
                  },
                  {
                    q: '加影中心提供哪些类型的护理？',
                  ...
                  {
                    q: 'Genesis Life Care 加影中心是否获得政府批准？',
                    a: '是的，Genesis Life Care 加影中心已在 JKM（社会福利部）注册并获得批准。我们还持有 AgeCope 认证，符合国际老年护理质量标准。',
                  },
                  {
                    q: '我可以在做决定之前参观加影中心吗？',
                  ...
                  {
                    q: 'Genesis Life Care 加影中心位于哪里？',
                    a: '我们位于 41, Jalan Ria 1, Kawasan Perindustrian Ria, 43500 Kajang, Selangor。中心交通便利，方便加影、士毛月、万宜及周边地区的家庭前来。',
                  },
                ].map((item, i) => (
              ...
              <div className="bg-primary-50 rounded-2xl p-6 border border-primary/10 mt-6">
                ...
                <p className="text-sm text-gray-500 mb-4">我们的护理顾问很乐意为您提供帮助。直接联系我们或预约免费参观加影中心。</p>
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    href={`tel:${centre.phone.replace(/\s/g, '')}`}
