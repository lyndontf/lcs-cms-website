...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: '芝拉斯附近的老年护理 - Genesis Life Care 加影',
    description:
      '芝拉斯附近的专业老年护理。24小时护理、失智症护理、中风康复。参观我们的加影中心 — 距芝拉斯仅数分钟。',
...
const faqs = [
  {
    q: '芝拉斯附近有养老院吗？',
    a: '有。Genesis Life Care 加影位于芝拉斯，距离约15分钟（经芝拉斯-加影高速公路）。我们提供24小时护理、失智症项目和中风康复服务。',
  },
  {
    q: '芝拉斯附近的老年护理费用是多少？',
  ...
  {
    q: '芝拉斯老年人可以获得哪些服务？',
    a: '我们的加影中心提供老年护理、失智症和记忆护理、中风康复、临终关怀、术后康复和老年日托项目。所有服务均包括驻场医生咨询。',
  },
  {
    q: '我可以在承诺前参观芝拉斯附近的养老院吗？',
    a: '当然可以。我们鼓励家庭预约参观我们的加影设施。您可以看到居住空间、见到护理团队并提出任何问题 — 无需承诺。',
  },
  {
  ...
  },
  {
    ...
    a: 'Genesis Life Care以驻场医生、心理学家主导的失智症项目、专业物理治疗团队和经济实惠的费率脱颖而出。我们的加影中心拥有120+床位，在谷歌上获得4.7星评分，来自克隆谷家庭的积极评价。',
  },
];
...
export default function ElderlyCareZhCheras() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                芝拉斯的家庭信任Genesis Life Care提供优质的养老服务。我们的加影中心距离只有{nearestCentre.distance}
            ...
            <div className="relative hidden lg:block">
              <div className="rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
                <img
                  ...
                  alt="Genesis Life Care 加影 — 芝拉斯附近的老年护理"
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg px-5 py-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">距芝拉斯</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2">芝拉斯附近的老年护理</p>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          ...
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto" style={{ color: 'white' }}>
            参观我们的加影中心进行免费参观。看看我们的护理空间、
            见见团队，并了解为什么芝拉斯的家庭信任Genesis Life Care。
          </p>
