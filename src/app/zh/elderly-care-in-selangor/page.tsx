...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: '雪兰莪老年护理 - Genesis Life Care 养老院',
    description:
      '雪兰莪专业老年护理。巴生谷地区 4 个分院。24/7 护理、失智症护理、中风康复。',
    images: [{ url: '/images/pj-centre.jpg', width: 1200, height: 630, alt: 'Genesis Life Care 雪兰莪分院' }],
  },
};
...
const faqs = [
  {
    q: 'Genesis Life Care 在雪兰莪有多少个分院？',
    a: 'Genesis Life Care 在雪兰莪拥有 4 个分院 — 位于八打灵再也（哥打白沙罗）、巴生、加影和蒲种。每个分院都提供 24/7 护理、失智症护理、中风康复和驻诊医生咨询。',
  },
  {
    q: '雪兰莪最好的养老院是哪一个？',
    a: 'Genesis Life Care 是雪兰莪排名最高的养老院提供商之一，所有四个分院的 Google 评分为 4.7 至 4.9 星。我们的八打灵再也旗舰分院评分为 4.9 星，超过 155 条评价。每个分院都提供专业护理、失智症护理和康复服务。',
  },
  {
    q: '雪兰莪的老年护理需要多少费用？',
    a: 'Genesis Life Care 在所有雪兰莪分院提供经济实惠的老年护理费率。费用取决于护理级别、房间类型和具体需求。请联系我们获取个性化报价 — 我们很乐意讨论适合您家庭预算的方案。',
  },
  {
    q: '雪兰莪的 Genesis Life Care 分院是否接收失智症患者？',
    a: '是的。雪兰莪的四个 Genesis Life Care 分院都提供由心理学家领导的失智症和记忆护理计划。我们的结构化认知刺激活动有助于维持失智症住户的心理功能和生活质量。',
  },
  {
    q: '我可以在做出决定前参观 Genesis Life Care 分院吗？',
    a: '当然可以。我们鼓励家庭预约免费参观我们四个雪兰莪分院中的任何一个。您可以查看生活空间、见面护理团队并提出问题 — 没有任何义务。请致电 +6019-325-0457 安排参访。',
  },
  {
    q: 'Genesis Life Care 服务雪兰莪的哪些地区？',
    a: '我们的四个分院战略性地位于巴生谷地区，为整个雪兰莪服务。八打灵再也分院覆盖大山脚、邦莎和蒙地基亚拉地区。巴生分院为沙亚南和巴生港服务。加影分院覆盖万宜、三面和芝星南部。蒲种分院为梳邦再也、USJ 和阳光城服务。',
  },
];
...
export default function ElderlyCarSelangorZh() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                Genesis Life Care 在雪兰莪巴生谷地区拥有 4 个专业养老院 — 分别位于八打灵再也、巴生、加影和蒲种。每个分院都提供 24/7 护理、驻诊医生咨询、失智症护理和全面康复服务。
              </p>
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg px-5 py-3 flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-gray-800">4 个地点</p>
                  <p className="text-xs text-gray-500">遍布雪兰莪</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2">雪兰莪老年护理</p>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
              遍布巴生谷的优质养老院
            </h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                雪兰莪是马来西亚发展最快、人口最多的州，巴生谷地区拥有数百万个家庭。随着人口老龄化，为全州家庭找到专业、可靠和经济实惠的老年护理已成为优先事项。
              </p>
              <p>
                Genesis Life Care 在巴生谷地区拥有 4 个战略性位置的分院，确保雪兰莪的家庭总能找到附近的优质养老院。无论您在八打灵再也、巴生、加影还是蒲种，都有一个 Genesis 分院在您附近 — 每个分院都提供 24 小时护理、每周驻诊医生咨询、由心理学家领导的失智症护理计划和完整的康复部门。
              </p>
              <p>
                我们的分院在 Google 上评分为 4.7 至 4.9 星，来自雪兰莪满意家庭的总评价超过 290 条。我们提供经济实惠的费率，不损害护理质量，使专业老年护理对更多马来西亚家庭可获得。
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2">我们的雪兰莪分院</p>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              遍布巴生谷的 4 个养老院
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              找到离您最近的 Genesis Life Care 分院。所有分院都提供相同高水准的专业护理。
            </p>
          </div>
            ...
            {selangorCentres.map((c, i) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <p className="text-xs text-gray-400 mb-2">({c.reviews} 条评价)</p>
                  ...
                  <p className="text-xs text-gray-500 mb-3">服务：{c.areas}</p>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">
            在雪兰莪找到 Genesis Life Care 分院
          </h2>
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto" style={{ color: 'white' }}>
            参观我们任何一个雪兰莪 4 个分院进行免费参观。查看我们的护理空间、见面护理团队，并了解为什么巴生谷地区的家庭信任 Genesis Life Care。
          </p>
