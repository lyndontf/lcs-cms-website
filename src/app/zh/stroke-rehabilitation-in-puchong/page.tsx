...
export const metadata: Metadata = {
  ...
  description:
    '蒲种专业中风康复。物理治疗、职业治疗和言语治疗。创世纪生命护理蒲种中心的个性化康复计划。评分4.7★。预约免费咨询。',
  openGraph: {
    title: '蒲种中风康复 - 创世纪生命护理',
    description:
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                我们位于Reko Sentral的蒲种中心服务来自蒲种、网城、布特拉再也及周边地区的家人。拥有{centre.beds}张床位和全天候护理，我们为中风恢复提供舒适和支持的环境。创世纪生命护理蒲种在谷歌上评分{centre.rating}星，拥有{centre.reviews}条来自信任我们照顾其亲人的家人的评价。
              </p>
            </div>
            <div>
              <img
