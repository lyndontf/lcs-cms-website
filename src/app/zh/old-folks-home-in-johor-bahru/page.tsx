...
const checklist = [
  ...
  { title: '位置与便利性', desc: '我们的柔佛州中心位于沙烈丹路假日广场，是一个著名的地标，易于从整个柔佛州和依斯干达玛来西亚抵达。' },
...
const faqs = [
  {
    q: '柔佛州的老人院费用是多少?',
    a: 'Genesis Life Care柔佛州的费用因所需护理水平和房间类型而异。与巴生谷相比，柔佛州具有生活成本优势，使优质老年护理更加负担得起。请与我们联系，获取基于您亲人需求的个性化报价。',
  },
  {
    q: '老人院和护理院有什么区别?',
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-lg text-white/90 max-w-xl mb-8 leading-relaxed" style={{ color: 'rgba(255,255,255,0.9)' }}>
                一个温暖、家庭式的环境，您的亲人以尊严和同情心获得专业护理。我们柔佛州假日广场中心配有失智症护理计划、康复设施和全天候可用的关怀团队。
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Genesis Life Care柔佛州是我们在巴生谷外的第一个中心，为南方地区提供马来西亚各地家族所依赖的相同可信护理标准。位于沙烈丹路假日广场，中央柔佛州的著名地标，我们的中心专为提供最高标准的老年护理而建。
                </p>
                <p>
                  我们为整个柔佛州、依斯干达玛来西亚、斯古代、居来和周边地区的家族服务。我们的中心靠近Sultan Aminah医院和其他主要柔佛州医疗设施，确保需要时能快速获得专科医疗支持。
                </p>
                <p>
                  我们的柔佛州老人院也为来自新加坡的马来西亚家族服务，他们希望其年迈的父母在附近得到照顾。凭借包括失智症计划、康复服务和营养膳食在内的全面专科护理，居民在一个屋檐下获得全面的个性化护理。
                </p>
              </div>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 py-16 sm:py-20 text-center">
          ...
          <p className="text-lg text-white/90 mb-8 max-w-xl mx-auto" style={{ color: 'rgba(255,255,255,0.9)' }}>
            预约我们柔佛州中心的免费参观。见见团队，参观设施，了解我们是否是您亲人的合适家园。无承诺。
          </p>
