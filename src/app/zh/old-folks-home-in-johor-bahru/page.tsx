...
const centre = {
  ...
  nursingHomeSlug: '/zh/nursing-home-in-johor-bahru',
  lat: 1.4655,
  lng: 103.7414,
};
...
const checklist = [
  ...
  { title: '位置与便利性', desc: 'Our JB centre at Holiday Plaza on Jalan Dato Sulaiman is a well-known landmark, easily accessible from across Johor Bahru and Iskandar Malaysia.' },
  { title: '可用的专科护理', desc: '除了基本护理，我们提供失智症计划、中风康复、临终关怀和术后康复。' },
];

const faqs = [
  {
    q: '在Johor Bahru的老人院费用是多少?',
  ...
  {
    q: 'Genesis Life Care Johor Bahru负担得起吗?',
    a: '是的。我们在所有中心提供具有竞争力和透明的费率。我们的团队与每个家族合作，推荐适合其需求和预算的护理计划。联系我们获取个性化报价。',
  },
  {
    q: '来自新加坡的家族能否将其父母安置在这个老人院?',
    a: '是的。我们为许多马来西亚和新加坡家族提供服务，他们更喜欢在Johor Bahru照顾年迈的父母。我们靠近新加坡边界，方便跨境访问，我们的护理标准符合两国家族的期望。',
  },
  {
    q: '在JB老人院的探访时间是什么?',
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="hidden lg:block">
              <div className="relative">
                <img src={centre.heroImg} alt={`${centre.fullName} — old folks home 乔豪州古来`} className="rounded-2xl shadow-2xl w-full object-cover" style={{ maxHeight: '420px' }} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-2 mt-6">
                {['南部地区', 'Holiday Plaza', '靠近HSA医院', '为JB和伊斯干达服务', '优质餐饮'].map((t) => (
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              Beyond everyday care, our old folks home 乔豪州古来 offers a full range of specialist services.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              { step: '2', title: '免费评估与参观', desc: '访问我们的 Johor Bahru centre, meet the care team, and we will assess your loved one\'s needs at no charge.' },
