...
export const metadata: Metadata = {
  title: '巴生护老院 - Genesis Life Care 巴生中心',
  description:
    'Genesis Life Care 巴生中心 — 我们创始的护老院，靠近巴生市的大型医院。配备现场医生、专业护理团队、康复服务及心理学家主导的失智症护理。收费合理。Google 评分 4.8★。预约免费参观。',
};
...
const highlights = [
  ...
  { label: '成立年份', value: '2018', sub: '创始中心' },
...
const facilityImages = [
  { src: '/images/klang-centre.jpg', alt: 'Genesis Life Care 巴生中心外观' },
  { src: '/images/services/rehab-department.jpg', alt: '康复区' },
  ...
  { src: '/images/services/halal-dinner.jpg', alt: '用餐区' },
];
...
const teamMembers = [
  {
    ...
    role: '运营总监',
    bio: '负责监管 Genesis Life Care 全部运营，确保所有中心患者护理达到最高标准。',
    img: '/images/team/team-1.png',
  },
  {
    name: 'Rose',
    role: '中心经理',
    bio: '管理巴生中心的日常运营，确保所有护理团队之间的顺畅协调。',
...
const testimonials = [
  {
    name: 'Alyse Cheong',
    text: '我妈妈在 Genesis Life Care 巴生中心住了 2 个多月做术后康复。她在这里住得很愉快。',
    rating: 5,
  },
  {
    name: 'Kenneth Ng',
    text: '我把妈妈送到这里做了 2 个月的髋关节手术后护理，他们照顾得很好，绝对是值得推荐的优质护老院。',
    rating: 5,
  },
  {
    name: 'Lee Steffi',
    text: '感谢 Dr Phoon 和您的团队对我妈妈的温柔护理。虽然她在这里的时间很短，但她安详地离开了，我真的很感谢。',
    rating: 4,
  },
];
...
const otherCentres = [
  ...
  { name: '加影', slug: 'nursing-home-kajang', rating: '4.7', tag: '南巴生谷', img: '/images/kajang-centre.jpeg' },
  { name: '蒲种', slug: 'nursing-home-in-puchong', rating: '4.8', tag: '现代化设施', img: '/images/puchong-centre.jpeg' },
  { name: '柔佛新山', slug: 'nursing-home-in-johor-bahru', rating: '4.8', tag: '南部地区', img: '/images/jb-centre.jpeg' },
];

/* ─── Page component ─────────────────────────────────────────────────── */

export default async function NursingHomeKlangZh() {
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{color: 'white'}}>
                我们的起点。我们位于巴生的创始中心提供现场医生咨询、专业护理团队和心理学家主导的失智症项目 — 便利地靠近大型医院。
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Genesis Life Care 巴生中心是我们 2018 年开始的地方。作为我们的创始中心，它在 Genesis 家族中占有特殊位置，并继续为巴生谷地的优质老年护理设定标准。
                </p>
                <p>
                  战略位置靠近<strong>腾古安潘拉希玛医院</strong>和其他大型医疗设施，我们的巴生中心为家属提供放心的保障，因为紧急医疗服务只需数分钟即可到达。
                </p>
                <p>
                  由<strong>Dr. Phang Sue Ling</strong> 主导，我们的运营总监，巴生中心配备现场医生每周检查每位住户一次、全天候专业护理、以及营养师监督的饮食项目。
                </p>
              </div>

              <div className="flex flex-wrap gap-3 mt-8">
                {['现场医生', '靠近医院', '失智症护理', '24/7 护理', '康复服务', '优质餐饮'].map((tag) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <div className="flex items-center justify-center gap-2 mt-3">
              ...
              <span className="text-gray-600 text-sm font-medium">来自 {centre.reviews} 条 Google 评价的 {centre.rating}</span>
            </div>
          </div>
              ...
              <div key={i} className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Google 评价</p>
                  </div>
                </div>
              </div>
            ))}
            ...
            <div className="relative grid lg:grid-cols-2 gap-10 lg:gap-16 items-center p-8 sm:p-12 lg:p-14">
              <div>
                ...
                <p className="text-gray-500 text-lg leading-relaxed mb-6">
                  根据您亲人所需的护理，获得即时的个性化估算。选择中心、房间类型、护理等级和附加服务——几秒钟内即可查看每月费用明细。
                </p>
                ...
                {[
                  {
                    ...
                    title: '选择您的中心',
                    desc: '比较我们在八打灵再也、巴生、加影、蒲种和新山的 5 个中心的价格。',
                  },
                  {
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                {[
                  {
                    q: '巴生养老院护理费用是多少？',
                    a: 'Genesis Life Care 巴生中心提供实惠的养老院套餐，起价 RM 2,500/月。费率根据房间类型和所需护理等级而有所不同。所有价格透明，无隐藏费用。',
                  },
                  {
                    q: '巴生中心提供哪些类型的护理？',
                  ...
                  {
                    q: 'Genesis Life Care 巴生中心是否获得政府批准？',
                    a: '是的，Genesis Life Care 巴生中心已在 JKM（社会福利部）注册并获得批准。我们还持有 AgeCope 认证，符合国际老年护理质量标准。',
                  },
                  {
                    q: '我可以在做决定之前参观巴生中心吗？',
                  ...
                  {
                    q: 'Genesis Life Care 巴生中心位于哪里？',
                    a: '我们位于 No.3, Jalan Istana, Amverton Business Centre, 41000 Klang, Selangor。中心交通便利，方便巴生及周边地区的家庭前来。',
                  },
                ].map((item, i) => (
              ...
              <div className="bg-primary-50 rounded-2xl p-6 border border-primary/10 mt-6">
                ...
                <p className="text-sm text-gray-500 mb-4">我们的护理顾问很乐意为您提供帮助。直接联系我们或预约免费参观巴生中心。</p>
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    href={`tel:${centre.phone.replace(/\s/g, '')}`}
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-3">不在巴生？我们在马来西亚还有 4 个地点。</p>
          </div>
