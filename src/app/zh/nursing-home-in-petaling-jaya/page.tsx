...
const highlights = [
  { label: '谷歌评分', value: '4.9 ★', sub: '58条评价' },
  { label: '床位', value: '50+', sub: '容量' },
  { label: '成立年份', value: '2020', sub: '八打灵再也' },
...
const services = [
  {
    title: '老年护理',
    desc: '全天候专业护理服务，针对每位住客的个性化护理计划。',
    icon: 'M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z',
    link: '/zh/our-services',
  },
  {
    title: '失智症与记忆护理',
    desc: '专门的记忆护理病房，由经验丰富的心理学家主导的结构化认知刺激计划。',
  ...
  {
    title: '临终关怀',
    desc: '同情心的生命终结护理，专注于舒适、尊严和家庭支持。',
    icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z',
    link: '/zh/palliative-care-malaysia',
  },
  {
    title: '术后康复',
    desc: '手术后的短期康复 — 在专业护理下恢复身体健康。',
...
const facilityImages = [
  { src: '/images/pj-centre.jpg', alt: 'Genesis Life Care PJ 建筑外观' },
  { src: '/images/services/rehab-department.jpg', alt: '康复区域' },
  { src: '/images/services/bedded-room.jpg', alt: '舒适的生活空间' },
  { src: '/images/services/common-area-scenic.jpg', alt: '公共活动区' },
...
const teamMembers = [
  {
    name: 'Sherrelyn',
    role: '中心经理',
    bio: '资深物理治疗师，领导八打灵再也康复团队，采用多学科方法。',
    img: '/images/team/team-1.png',
  },
  {
    name: 'Joharry Mustafa',
    role: '督导员',
    bio: '确保运营顺利进行，充当护理团队与各部门之间的联络人。',
    img: '/images/team/team-2.png',
  },
  {
    name: 'Seow Zhi Heng',
    role: '高级治疗师',
    bio: '专业从事老年人康复，采用以患者为中心的多学科方法。',
...
const testimonials = [
  {
    name: 'Mei Ling T.',
    text: '八打灵再也中心对我母亲的帮助非常大。员工真诚关怀，记忆护理病房正是她所需要的。我们很放心，知道她在良好的照护中。',
    rating: 5,
  },
  {
    name: 'Ahmad R.',
    text: '非常专业和充满爱心的团队。康复设施帮助我父亲比预期更快地从中风中恢复。强烈推荐。',
    rating: 5,
  },
  {
    name: 'Sarah L.',
    text: '干净、维护良好的设施和友善的员工。八打灵再也的地理位置对我们的家庭拜访非常便利。感谢 Genesis!',
    rating: 5,
  },
];

const otherCentres = [
  { name: 'Klang', slug: 'nursing-home-in-klang', rating: '4.8', tag: '创始中心' },
  { name: 'Kajang', slug: 'nursing-home-kajang', rating: '4.7', tag: '南巴生谷' },
  { name: 'Puchong', slug: 'nursing-home-in-puchong', rating: '4.8', tag: '现代化设施' },
  { name: 'Johor Bahru', slug: 'nursing-home-in-johor-bahru', rating: '4.8', tag: '南部地区' },
];

/* ─── Page component ─────────────────────────────────────────────────── */

export default async function NursingHomePJZh() {
  const siteId = await getCurrentSiteId();
  const recentPosts = await getPublishedPosts(siteId || undefined);
  return (
    <main className="bg-white">
      {/* ── HERO ──────────────────────────────────────────────────────── */}
      <section className="pj-hero relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-white/85 leading-relaxed mb-8 max-w-xl">
                我们在八打灵再也的旗舰中心配有专门的记忆护理病房、全面的康复设施和24/7专业护理服务 — 所有这一切都在温暖、家庭式的环境中。
              </p>
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg px-5 py-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">卫生部认证</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Genesis Life Care 八打灵再也是我们的旗舰护理中心，目的是提供最高标准的长期和康复护理。我们的中心位于第51区中心，交通便利，距离主要医院仅几分钟车程。
                </p>
                <p>
                  八打灵再也中心的特色是我们的<strong>专门记忆护理病房</strong> — 一个为患有失智症和阿尔茨海默病的住客设计的专业单位。该病房由经验丰富的心理学家监督，制定结构化认知刺激计划和为每位住客量身定制的日常活动。
                </p>
                <p>
                  我们的<strong>全面康复设施</strong>包括物理治疗和职业治疗套房，可提供中风恢复、术后康复和行动能力改善计划 — 所有这一切都在一个屋顶下进行。
                </p>
              </div>

              <div className="flex flex-wrap gap-3 mt-8">
                {['记忆护理病房', '康复设施', '物理治疗与职业治疗', '24/7 护理', '医生访问', '优质餐饮'].map((tag) => (
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-5 -right-5 bg-primary text-white rounded-xl px-6 py-4 shadow-lg hidden sm:block">
                ...
                <p className="text-sm font-medium text-white/80">床位容量</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                {[
                  {
                    q: '八打灵再也养老院护理费用是多少？',
                    a: 'Genesis Life Care 八打灵再也中心提供实惠的养老院套餐，起价 RM 2,800/月。费率根据房间类型和所需护理等级而有所不同。所有价格透明，无隐藏费用。使用我们的在线费用计算器或联系我们获取个性化报价。',
                  },
                  {
                    q: '八打灵再也中心提供哪些类型的护理？',
                  ...
                  {
                    q: 'Genesis Life Care 八打灵再也中心是否获得政府批准？',
                    a: '是的，Genesis Life Care 八打灵再也中心已在 JKM（社会福利部）注册并获得批准。我们还持有 AgeCope 认证，符合国际老年护理质量标准。',
                  },
                  {
                    q: '我可以在做决定之前参观八打灵再也中心吗？',
                    a: '当然可以。我们鼓励家庭预约免费参观和咨询。我们的护理顾问将带您参观设施，解释我们的护理计划，并帮助您为亲人找到合适的解决方案。',
                  },
                  {
                    q: 'Genesis Life Care 八打灵再也中心位于哪里？',
                    a: '我们位于 Lot 1, Petaling Utama Avenue, Jalan PJS 1/50, Taman Petaling Utama, 46150 Petaling Jaya, Selangor。中心交通便利，方便八打灵再也、蒲种、巴生谷及周边地区的家庭前来。',
                  },
                ].map((item, i) => (
              ...
              <div className="bg-primary-50 rounded-2xl p-6 border border-primary/10 mt-6">
                ...
                <p className="text-sm text-gray-500 mb-4">我们的护理顾问很乐意为您提供帮助。直接联系我们或预约免费参观八打灵再也中心。</p>
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    href={`tel:${centre.phone.replace(/\s/g, '')}`}
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-3">不在八打灵再也？我们在马来西亚还有4个地点。</p>
          </div>
      ...
      <section className="pj-cta relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          ...
          <p className="text-lg text-white/85 mb-8 max-w-2xl mx-auto">
            预约参观我们的八打灵再也设施。参观记忆护理病房、康复区域，并认识我们的护理团队 — 不产生任何义务。
          </p>
