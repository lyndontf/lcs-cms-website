    ...
    <main className="bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-16 sm:py-24">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="lg:col-span-2 hidden lg:block">
              <HeroEnquiryForm centreName="加影" pageUrl="/zh/old-folks-home-in-kajang" lang="zh" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 bg-[#f4f8fb]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div>
            <div>
              <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2 text-center">实用指南</p>
