...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: '达曼莎拉附近的老年护理 - Genesis Life Care 八打灵再也',
    description:
      '达曼莎拉附近的专业老年护理。24小时护理、失智症护理、中风康复。参观我们的八打灵再也中心 — 距达曼莎拉仅数分钟。',
...
const nearestCentre = {
  ...
  address: '47810 八打灵再也，古达曼莎拉Dataran Sunway，Jalan PJU 5/9，No. 33-1，雪兰莪州',
  rating: '4.9',
  reviews: 155,
  beds: '50+',
  distance: '约10分钟',
...
const faqs = [
  {
    q: '达曼莎拉附近有养老院吗？',
    a: '有。Genesis Life Care 八打灵再也位于古达曼莎拉，距离达曼莎拉高地、达曼莎拉乌达玛和达曼莎拉再也约10分钟。我们提供24小时护理、失智症项目和中风康复服务。',
  },
  {
    q: '达曼莎拉附近的老年护理费用是多少？',
    a: 'Genesis Life Care 为专业老年护理提供经济实惠的费率。费用根据护理等级和房间类型而异。请联系我们获取个性化报价 — 我们很乐意讨论适合您家庭预算的选项。',
  },
  {
    q: '达曼莎拉附近有哪些老年护理服务？',
    a: '我们的八打灵再也中心提供老年护理、失智症和记忆护理、中风康复、临终关怀、术后康复和老年日托项目。所有服务均包括驻场医生咨询。',
  },
  {
    q: '我可以在承诺前参观达曼莎拉附近的养老院吗？',
    a: '当然可以。我们鼓励家庭预约参观我们的八打灵再也设施。您可以看到居住空间、见到护理团队并提出任何问题 — 无需承诺。',
  },
  {
    q: 'Genesis Life Care距离达曼莎拉高地有多远？',
    a: '我们的八打灵再也中心在古达曼莎拉，距离达曼莎拉高地约10分钟，经LDP或SPRINT高速公路。从达曼莎拉乌达玛和达曼莎拉再也也可轻松到达。',
  },
  {
    q: 'Genesis Life Care与达曼莎拉附近的其他养老院有什么不同？',
    a: 'Genesis Life Care以驻场医生、心理学家主导的失智症项目、专业物理治疗团队和经济实惠的费率脱颖而出。我们在谷歌上获得4.9星评分，来自超过155条满意家庭的评价。',
  },
];
...
export default function ElderlyCareZhDamansara() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                达曼莎拉的家庭信任Genesis Life Care提供优质的养老服务。我们的八打灵再也中心距离仅{nearestCentre.distance}
                — 提供24小时护理、驻场医生咨询、失智症护理
                和全面康复。
              </p>
            ...
            <div className="relative hidden lg:block">
              <div className="rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
                <img
                  ...
                  alt="Genesis Life Care 八打灵再也 — 达曼莎拉附近的老年护理"
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg px-5 py-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">距达曼莎拉</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2">达曼莎拉附近的老年护理</p>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
              为达曼莎拉家庭提供优质养老服务
            </h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                达曼莎拉包括几个富裕的住宅区，如达曼莎拉高地、达曼莎拉乌达玛和达曼莎拉再也 — 克隆谷许多多代同堂家庭的家园。随着父母年龄增长，对达曼莎拉地区的家庭来说，找到可靠和专业的老年护理是一个优先事项。
              </p>
              <p>
                Genesis Life Care 八打灵再也是离达曼莎拉最近的Genesis中心 — 位于古达曼莎拉，仅短距离。我们的设施提供24小时护理、周期性驻场医生咨询、心理学家主导的失智症项目，以及包括物理治疗和职业治疗的完整康复部门。
              </p>
              <p>
                无论您的亲人需要长期住宅护理、手术后康复或专业失智症支持，我们的八打灵再也中心都提供安全和关怀的环境，价格经济实惠。我们获得{nearestCentre.rating}星谷歌评分，来自克隆谷超过{nearestCentre.reviews}条满意家庭的评价。
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              距达曼莎拉仅{nearestCentre.distance} — 我们的旗舰中心位于古达曼莎拉。
            </p>
          </div>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          ...
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto" style={{ color: 'white' }}>
            参观我们的八打灵再也中心进行免费参观。看看我们的护理空间、
            见见团队，并了解为什么达曼莎拉的家庭信任Genesis Life Care。
          </p>
