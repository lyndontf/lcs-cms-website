...
const highlights = [
  ...
  { label: '成立年份', value: '2022', sub: '现代化设施' },
...
const services = [
  ...
  {
    title: '老年日间护理',
    desc: '日间护理计划，包括社交活动、餐饮和监督，适合居家养老的老年人。',
...
const facilityImages = [
  { src: '/images/puchong-centre.jpeg', alt: 'Genesis Life Care Puchong 外观' },
...
const teamMembers = [
  ...
  },
  {
    name: 'Jenny',
    role: '中心经理',
    bio: '管理普城中心的日常运营，确保为所有住户提供温馨高效的环境。',
...
const testimonials = [
  {
    name: 'Sarah Tan',
    text: '普城中心非常干净，维护得很好。工作人员总是友善，关注我父亲的需求。非常感谢找到了 Genesis。',
    rating: 5,
  },
  {
    name: 'Ahmad Razak',
    text: '现代化设施和体贴的员工。我母亲已经在这里住了3个月，对食物和活动都很满意。位置也很便利。',
    rating: 5,
  },
  {
    name: 'Michelle Lim',
    text: '术后康复计划体验很好。治疗师很专业，我父亲的恢复比预期更快。',
    rating: 4,
  },
];
...
export default async function NursingHomePuchongZh() {
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{color: 'white'}}>
                位于班达普特里中心的现代化老年护理中心，交通便利，有便捷的高速公路接驳。提供全面的老年护理服务，包括康复、失智症计划和老年日间护理 — 所有服务均在当代、目的导向的设施内。
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Genesis Life Care Puchong 是我们位于繁荣的班达普特里城镇的现代化设施。通过 LDP 和 ELITE 高速公路的便利通道，巴生谷各地的家庭可以方便地探访亲属。
                </p>
                <p>
                  该中心设有专为康复、记忆护理和日常活动而设计的空间 — 所有设施均按照最新护理标准建造。我们的开放式公共区域促进住户之间的社交互动和社区意识。
                </p>
                <p>
                  我们的护理团队提供全天候护理支持、每周医生咨询和个性化护理计划，根据每位住户的独特需求和偏好量身定制。
                </p>
              </div>

              <div className="flex flex-wrap gap-3 mt-8">
                {['高速公路接驳', '现代设计', '失智症护理', '24/7 护理', '康复服务', '优质餐饮'].map((tag) => (
            ...
            <div className="relative">
              <img
                ...
                alt="Genesis Life Care Puchong 建筑"
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                {[
                  {
                    q: '蒲种养老院护理费用是多少？',
                    a: 'Genesis Life Care 蒲种中心提供实惠的养老院套餐，起价 RM 2,500/月。费率根据房间类型和所需护理等级而有所不同。所有价格透明，无隐藏费用。使用我们的在线费用计算器或联系我们获取个性化报价。',
                  },
                  {
                    q: '蒲种中心提供哪些类型的护理？',
                  ...
                  {
                    q: 'Genesis Life Care 蒲种中心是否获得政府批准？',
                    a: '是的，Genesis Life Care 蒲种中心已在 JKM（社会福利部）注册并获得批准。我们还持有 AgeCope 认证，符合国际老年护理质量标准。',
                  },
                  {
                    q: '我可以在做决定之前参观蒲种中心吗？',
                  ...
                  {
                    q: 'Genesis Life Care 蒲种中心位于哪里？',
                    a: '我们位于 16, Jln TPP 1/1, Taman Perindustrian Puchong, 47100 Puchong, Selangor。中心交通便利，方便蒲种、士佳城、赛城及周边地区的家庭前来。',
                  },
                ].map((item, i) => (
              ...
              <div className="bg-primary-50 rounded-2xl p-6 border border-primary/10 mt-6">
                ...
                <p className="text-sm text-gray-500 mb-4">我们的护理顾问很乐意为您提供帮助。直接联系我们或预约免费参观蒲种中心。</p>
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    href={`tel:${centre.phone.replace(/\s/g, '')}`}
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 mt-3">不在普城？我们在全马来西亚有 4 个其他地点。</p>
          </div>
