...
const faqs = [
  {
    q: 'Is there a nursing home near Bangsar?',
    a: 'Yes. Genesis Life Care Petaling Jaya is located in Kota Damansara, approximately 15 minutes from Bangsar. We offer 24/7 nursing care, dementia programmes, and stroke rehabilitation services.',
  },
  {
    q: 'How much does elderly care cost near Bangsar?',
  ...
  {
    q: 'What services are available for elderly residents from Bangsar?',
  ...
  {
    q: 'Can I visit the nursing home before committing?',
    a: 'Absolutely. We encourage families to book a free tour of our Petaling Jaya facility. You can see the living spaces, meet the care team, and ask any questions — with no obligations.',
  },
  {
    q: 'Does Genesis Life Care provide transport from Bangsar?',
    a: 'While we do not provide regular transport services, our Petaling Jaya centre is easily accessible from Bangsar via major highways (LDP, Sprint, NKVE). The drive typically takes about 15 minutes.',
  },
  {
    q: 'What makes Genesis Life Care different from other nursing homes near Bangsar?',
  ...
  '@graph': [
    {
      ...
      description: 'Professional elderly care and nursing home near Bangsar, Petaling Jaya.',
      url: 'https://genesiscare.com.my/elderly-care-in-bangsar',
...
export default function ElderlyCareBangsar() {
  return (
    <main className="bg-white">
            ...
            <div className="relative hidden lg:block">
              <div className="rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
                <img
                  ...
                  alt="Genesis Life Care Petaling Jaya — nearest elderly care to Bangsar"
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg px-5 py-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">from Bangsar</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* ── ABOUT ELDERLY CARE IN BANGSAR ─────────────────────────────── */}
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2">Elderly Care Near Bangsar</p>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
              Quality Nursing Home Services for Bangsar Families
            </h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                Bangsar is one of Kuala Lumpur&apos;s most established residential neighbourhoods, home to
                many multigenerational families. As parents age, finding reliable and professional
                elderly care close to home becomes a priority for Bangsar residents.
              </p>
              <p>
                Genesis Life Care Petaling Jaya is the nearest Genesis centre to Bangsar — located in
                Kota Damansara, just a short drive via the LDP or Sprint highways. Our facility
                provides 24-hour nursing care, weekly on-site doctor consultations, psychologist-led
                dementia programmes, and a full rehabilitation department with physiotherapy and
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              Elderly Care Services Available Near Bangsar
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              Comprehensive care services for seniors, all available at our Petaling Jaya centre.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              Just {nearestCentre.distance} from Bangsar — our flagship centre in Kota Damansara.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              Common questions about elderly care options near Bangsar.
            </p>
          </div>
      ...
      <FaqSection
        faqs={[
          {
            q: 'Is the Petaling Jaya centre near Bangsar our flagship location?',
            a: 'Yes, our Petaling Jaya centre in Kota Damansara is our flagship facility with 50+ beds and highest Google rating (4.9★). It\'s the closest Genesis centre to Bangsar with comprehensive services.'
          },
          {
            q: 'Can Bangsar residents with advanced dementia access specialized care?',
            a: 'Yes. Our psychologist-led dementia programmes at the PJ centre are designed for early-stage through advanced dementia. We provide structured cognitive stimulation and 24/7 memory care support.'
          },
          {
            q: 'What accessibility features are available at the PJ centre for stroke rehabilitation?',
            a: 'Our facility has wheelchair accessibility, physiotherapy equipment, occupational therapy spaces, and trained therapists. Bangsar stroke survivors receive personalized recovery programs.'
          },
          {
            q: 'Is family involvement encouraged at the Petaling Jaya centre?',
            a: 'Absolutely. We involve families in care planning, therapy sessions, and daily activities. Bangsar families often participate in rehabilitation progress meetings and social events.'
          },
          {
            q: 'Does the PJ flagship centre offer educational workshops for family members?',
            a: 'Yes, we conduct workshops on dementia care, stroke recovery support, and elderly wellness for family members. Bangsar families can participate in these educational sessions.'
          }
        ]}
        heading="Bangsar-Area Specific FAQs"
        label="Petaling Jaya Flagship"
      />

      {/* ── BOTTOM CTA ────────────────────────────────────────────────── */}
      <FinalCtaSection
        heading="Find Quality Elderly Care Near Bangsar"
        description="Visit our Petaling Jaya centre for a free tour. See our care spaces, meet the team, and discover why families across Bangsar trust Genesis Life Care."
