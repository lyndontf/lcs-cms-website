  ...
  '@graph': [
    {
      ...
      url: 'https://genesiscare.com.my/stroke-rehabilitation-in-puchong',
...
export default function StrokeRehabPuchong() {
  return (
    <main className="bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
              Expert Stroke Recovery Services in Puchong
            </h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                After a stroke, timely and professional rehabilitation is critical to maximising
              ...
              <p>
                Our rehabilitation approach integrates physiotherapy for restoring movement and
              ...
              <p>
                Our Puchong centre is a modern facility located at Taman Perindustrian Puchong,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              A comprehensive, multidisciplinary approach to stroke recovery at our Puchong centre.
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              Care Services at Our Puchong Centre
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              Visit Our Puchong Centre
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              A modern facility with dedicated stroke rehabilitation services in Puchong.
            </p>
          </div>
      ...
      <FinalCtaSection heading="Start Your Stroke Recovery Journey in Puchong" description="Visit our Puchong centre for a free consultation. Meet our rehabilitation team and discover how we can help your loved one recover from stroke." centre={centre} />
    </main>
  );
}
