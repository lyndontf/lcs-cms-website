...
export const metadata: Metadata = {
  title: 'Dementia Care in Puchong - Memory Care Puchong | Genesis Life Care',
  description:
  ...
  '@graph': [
    {
      ...
      url: 'https://genesiscare.com.my/dementia-care-in-puchong',
...
export default function DementiaCarePuchong() {
  return (
    <main className="bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2" style={{ color: 'white' }}>Dementia Care in Puchong</p>
              <h1 className="text-4xl sm:text-5xl font-extrabold leading-[1.1] tracking-tight text-white mb-5" style={{ color: 'white' }}>
                Dementia Care in<br />Puchong
              </h1>
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                Genesis Life Care Puchong provides specialised dementia and memory care with
                psychologist-led programmes, 24/7 nursing supervision, and a safe, modern
                environment — serving families in Puchong, Subang Jaya, USJ, and surrounding areas.
              </p>
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg px-5 py-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Puchong, Selangor</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2">Dementia Care in Puchong</p>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                ...
                more families in Puchong, Subang Jaya, USJ, and the central Klang Valley
                are seeking professional dementia care for their loved ones.
              </p>
              <p>
              ...
              <p>
                At Genesis Life Care Puchong — our modern facility — our approach to
                dementia care is led by qualified psychologists who design structured
                cognitive stimulation programmes. Combined with 24-hour nursing care,
                on-site doctor consultations, and a safe environment, we help residents
                maintain their dignity and quality of life. Learn more about our{' '}
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">Our Dementia Care Approach</h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">A comprehensive, psychologist-led approach to dementia care at our Puchong centre.</p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">All Services at Our Puchong Centre</h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">Beyond dementia care, we offer a full range of elderly care services.</p>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">Visit Our Puchong Centre</h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">Our modern facility — specialised dementia care in Puchong.</p>
          </div>
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-8">
                <div className="flex items-center gap-2 mb-3">
                  <span className="bg-gold text-gray-900 text-xs font-bold px-3 py-1 rounded-full">Modern Facility</span>
                ...
                <div className="flex flex-wrap gap-3">
                  <Link href="/contact" className="inline-flex items-center gap-2 bg-primary text-white font-bold px-5 py-3 rounded-lg hover:bg-primary-600 transition-colors text-sm">
                    Book a Free Tour <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg>
                  </Link>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">Common questions about dementia care in Puchong.</p>
          </div>
      ...
      <FaqSection faqs={[
        {
          q: 'What dementia care expertise does your Puchong team have?',
          a: 'Our Puchong centre has a dedicated psychologist and care team trained extensively in person-centred dementia care. We provide cognitive stimulation activities, therapeutic interventions, and structured memory support programmes tailored to each resident\'s needs.',
        },
        {
          q: 'How large is your Puchong dementia care unit?',
          a: 'Our Puchong centre has 120+ beds with dedicated dementia care units designed for safety and comfort. Units feature secure perimeters, colour-coded wayfinding, fall-prevention measures, and comfortable common spaces for activities.',
        },
        {
          q: 'What therapeutic activities are offered for dementia residents in Puchong?',
          a: 'We offer cognitive stimulation activities, therapeutic music, art therapy, reminiscence activities, gentle exercise programmes, gardening therapy, and social activities. All activities are tailored to residents\' abilities and interests.',
        },
        {
          q: 'Can families visit dementia residents at your Puchong centre?',
          a: 'Yes. Visiting hours are flexible, and families can visit anytime. We encourage family involvement in care planning and activities. We also provide family support programmes and education about dementia care.',
        },
        {
          q: 'How is dementia progression monitored at your Puchong facility?',
          a: 'Our team regularly assesses residents using standardised cognitive assessments, monitors changes in behaviour and function, and adjusts care plans accordingly. We coordinate with doctors and specialists for medical management of dementia-related conditions.',
        },
      ]} />

      <FinalCtaSection heading="Ready for Specialised Dementia Care in Puchong?" description="Visit our Puchong centre for a free tour. See our dementia care spaces, meet the psychologist and care team, and learn how we support families living with dementia." />
    </main>
  );
}
