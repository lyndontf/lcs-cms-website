        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-4">
              ...
              {social.xiaohongshu && (
                <a href={social.xiaohongshu} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="小红书 (RED Note)">
          ...
          {/* Company */}
          <div>
            <h4 className="text-sm font-semibold text-white uppercase tracking-wider mb-4">公司</h4>
