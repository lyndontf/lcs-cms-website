...
const highlightsZh = [
  { label: '服务年资', sub: '始于2021年' },
  { label: '居民容量', sub: '舒适床位' },
  { label: zhCommon.googleRating, sub: '32则评价' },
  { label: '实惠价格', sub: '所有中心' },
  { label: '护理人员', sub: '全天候' },
];
...
const checklistZh = [
  ...
  { title: '地点与交通', desc: '我们的加影中心可轻松经由SILK大道、南北大道（PLUS Highway）及加影地铁站抵达，并设有充足的访客停车位。' },
...
const admissionStepsZh = [
  ...
  { title: '免费评估与参观', desc: '参观我们的加影中心，与护理团队见面，我们将免费评估您亲人的需求。' },
...
const faqsZh = [
  {
    q: '加影老年人之家要多少钱？',
    a: 'Genesis Life Care Kajang的费用取决于所需护理的水平和房间类型。我们提供具有竞争力的价格，基本护理每月从约RM 2,500开始。根据您亲人的需求，请与我们联系获取个性化报价。',
  },
  {
    q: '老年人之家和疗养院有什么区别？',
  ...
  {
    q: 'Genesis Life Care Kajang价格合理吗？',
...
function buildJsonLd(locale: 'en' | 'zh') {
  ...
  const pageUrl = `https://genesiscare.com.my${urlPrefix}/old-folks-home-in-kajang`;
  return {
    localBusiness: {
...
// Lives outside src/app so both /old-folks-home-in-kajang/page.tsx and
// /zh/old-folks-home-in-kajang/page.tsx can import it — a Next.js route
...
export function OldFolksHomeKajangContent({ locale = 'en' }: { locale?: 'en' | 'zh' } = {}) {
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-sm font-bold uppercase tracking-widest text-white/70 mb-3" style={{ color: 'rgba(255,255,255,0.7)' }}>
                <Bilingual en={<>Old Folks Home in {centre.name}</>} zh="加影老年人之家" />
              </p>
              <h1 className="text-4xl sm:text-5xl font-extrabold text-white leading-tight mb-6" style={{ color: 'white' }}>
                <Bilingual en={<>Best Old Folks Home<br className="hidden sm:block" /> in {centre.name}</>} zh={<>最佳老年人之家<br className="hidden sm:block" />加影</>} />
              </h1>
              <p className="text-lg text-white/90 max-w-xl mb-8 leading-relaxed" style={{ color: 'rgba(255,255,255,0.9)' }}>
                <Bilingual
                  en="A warm, family-friendly environment where your loved ones receive professional care with dignity and compassion. Our Kajang centre features 24/7 nursing care, an in-house kitchen, dementia care, and rehabilitation facilities serving the southern Klang Valley."
                  zh="一个温暖、家庭友好的环境，您的亲人在这里获得尊严和同情心的专业护理。我们的加影中心提供24/7护理、内部厨房、痴呆症护理和康复设施，为南巴生谷地区提供服务。"
                />
              </p>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2"><Bilingual en="Why Kajang" zh="为何选择加影" /></p>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-6">
                <Bilingual en="Why Choose Our Old Folks Home in Kajang?" zh="为何选择我们在加影的老年人之家？" />
              </h2>
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  <Bilingual
                    en="Finding the right old folks home for your loved one is one of the most important decisions a family can make. Located in the heart of southern Klang Valley, Kajang is a growing family-friendly area, and our centre in Kawasan Perindustrian Ria sits in a quiet neighbourhood — perfect for elderly care."
                    zh="为亲人找到合适的老年人之家，是家庭需要做出的最重要决定之一。加影位于南巴生谷核心地带，是一个不断发展、适合家庭居住的地区，我们位于Kawasan Perindustrian Ria的中心坐落于宁静的社区——非常适合乐龄护理。"
                  />
                </p>
                <p>
                  <Bilingual
                    en="Our Kajang old folks home is situated near Hospital Kajang, making it easy for families to manage medical appointments. The centre is accessible from SILK Highway, PLUS Highway, and Kajang MRT station, ensuring stress-free family visits from Kajang, Bangi, Semenyih, and surrounding areas."
                    zh="我们的加影老年人之家邻近加影医院（Hospital Kajang），方便家属安排就医预约。中心可经由SILK大道、南北大道（PLUS Highway）及加影地铁站抵达，让来自加影、万挠、士毛月及周边地区的家属探访无压力。"
                  />
                </p>
                <p>
                  <Bilingual
                    en="What sets our Kajang old folks home apart is the strong emphasis on quality in-house dining and personalised care, reflecting the needs of the local Kajang community. Combined with round-the-clock nursing care, dementia programmes, rehabilitation services, and a warm home-like atmosphere, we provide comprehensive elderly care that families can trust."
                    zh="我们加影老年人之家的特色，在于高度重视优质内部餐饮与个性化护理，充分照顾当地加影社区的需求。结合全天候护理、痴呆症护理计划、康复服务以及温馨的家庭氛围，我们为家属提供值得信赖的全面乐龄护理。"
                  />
                </p>
              </div>
              <div className="flex flex-wrap gap-2 mt-6">
                {[
                  { en: 'Southern Klang Valley', zh: '南巴生谷' },
                  { en: 'Near Hospital Kajang', zh: '靠近加影医院' },
                  { en: 'Quality Dining', zh: '优质餐饮' },
                  { en: 'SILK Highway Access', zh: 'SILK大道直达' },
                  { en: 'MRT Accessible', zh: '地铁直达' },
                ].map((t) => (
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              <Bilingual en="Beyond everyday care, our old folks home in Kajang offers a full range of specialist services." zh="除日常护理外，我们加影的老年人之家还提供全方位的专科服务。" />
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-8">
            <Link href={centre.nursingHomeSlug} className="text-primary font-semibold text-sm hover:underline">
              <Bilingual en={<>View full centre details for {centre.name} →</>} zh="查看加影完整中心详情 →" />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 py-16 sm:py-20 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4" style={{ color: 'white' }}>
            <Bilingual en={<>Visit Our Old Folks Home in {centre.name}</>} zh="参观我们在加影的老年人之家" />
          </h2>
          <p className="text-lg text-white/90 mb-8 max-w-xl mx-auto" style={{ color: 'rgba(255,255,255,0.9)' }}>
            <Bilingual
              en="Schedule a free walkthrough of our Kajang centre. Meet the team, see the facilities, and find out if we are the right home for your loved one. No obligations."
              zh="预约免费参观我们的加影中心，认识团队、了解设施，看看我们是否适合您的亲人——完全不设任何义务。"
            />
          </p>
