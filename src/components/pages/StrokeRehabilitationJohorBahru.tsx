...
const faqs = [
  {
    q: 'What stroke rehabilitation services are available in Johor Bahru?',
    a: 'Genesis Life Care Johor Bahru offers comprehensive stroke rehabilitation including physiotherapy, occupational therapy, and speech and language therapy. Our multidisciplinary team designs personalised recovery plans to help stroke survivors regain mobility, independence, and communication skills.',
  },
  {
    q: 'How soon after a stroke should rehabilitation begin?',
    a: 'Stroke rehabilitation should ideally begin as soon as the patient is medically stable, typically within 24 to 48 hours after the stroke. Early rehabilitation has been shown to significantly improve recovery outcomes. Our team works closely with hospitals in Johor Bahru to ensure a smooth transition into our rehab programme.',
  },
  {
    q: 'How long does stroke rehabilitation take at Genesis Life Care JB?',
  ...
  {
    q: 'Does Genesis Life Care JB provide speech therapy for stroke patients?',
    a: 'Yes, our Johor Bahru centre provides speech and language therapy as part of our stroke rehabilitation programme. This includes therapy for communication difficulties such as aphasia, as well as swallowing therapy for patients with dysphagia following a stroke.',
  },
  {
    q: 'How much does stroke rehabilitation cost in Johor Bahru?',
...
const faqsZh = [
  {
    q: '新山提供哪些中风康复服务？',
    a: 'Genesis Life Care新山提供全面的中风康复，包括物理治疗、职业治疗和言语及语言治疗。我们的多学科团队为中风幸存者设计个性化康复计划，帮助他们恢复活动能力、独立性和沟通技能。',
  },
  {
    q: '中风后多久应该开始康复？',
    a: '中风康复应在患者医学稳定后尽快开始，通常在中风后24至48小时内。早期康复已被证明能显著改善康复预后。我们的团队与新山的医院密切合作，确保顺利进入我们的康复项目。',
  },
  {
    q: 'Genesis Life Care新山的中风康复需要多长时间？',
    a: '中风康复的持续时间取决于中风的严重程度和个人恢复进度。一些患者在数周内看到显著改善，而其他患者可能需要数月的治疗。我们设定个性化里程碑并定期重新评估每位患者的计划。',
  },
  {
    q: 'Genesis Life Care新山为中风患者提供言语治疗吗？',
    a: '是的，我们的新山中心提供言语和语言治疗，作为中风康复项目的一部分。这包括治疗失语症等沟通困难，以及中风后吞咽困难患者的吞咽治疗。',
  },
  {
    q: '新山的中风康复费用是多少？',
...
const sharedCentre = centres['johor-bahru'];
  ...
  '@graph': [
    {
      ...
      description: 'Professional stroke rehabilitation centre in Johor Bahru offering physiotherapy, occupational therapy, and speech therapy for stroke recovery.',
      url: `https://genesiscare.com.my${urlPrefix}/stroke-rehabilitation-in-johor-bahru`,
...
// Lives outside src/app so both /stroke-rehabilitation-in-johor-bahru/page.tsx
// and /zh/stroke-rehabilitation-in-johor-bahru/page.tsx can import it — a
// Next.js route file (page.tsx) is only allowed to export the whitelisted
// route exports (default, metadata, revalidate, ...), so this can't live
// in either one.

export function StrokeRehabilitationJohorBahruContent({ locale = 'en' }: { locale?: 'en' | 'zh' } = {}) {
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2" style={{ color: 'white' }}>
                <Bilingual en="Stroke Recovery in Johor Bahru" zh="新山中风康复" />
              </p>
              <h1 className="text-4xl sm:text-5xl font-extrabold leading-[1.1] tracking-tight text-white mb-5" style={{ color: 'white' }}>
                <Bilingual en={<>Stroke Rehabilitation<br />in Johor Bahru</>} zh={<>中风康复<br />新山</>} />
              </h1>
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                <Bilingual
                  en={<>Genesis Life Care Johor Bahru provides comprehensive stroke rehabilitation
                  with physiotherapy, occupational therapy, and speech therapy. Our dedicated
                  southern region team helps stroke survivors regain independence with personalised
                  recovery plans and 24-hour nursing support in our {centre.beds} bed facility.</>}
                  zh={<>Genesis Life Care新山提供全面的中风康复，包括物理治疗、职业治疗和言语治疗。我们专业的南部地区团队协助中风幸存者透过个性化康复计划和24小时护理支持，在我们{centre.beds}张床位的设施中恢复独立性。</>}
                />
              </p>
            ...
            <div className="relative hidden lg:block">
              <div className="rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
                <img
                  src={centre.img}
                  alt="Stroke Rehabilitation Centre in Johor Bahru — Genesis Life Care"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
              <Bilingual en="Expert Stroke Recovery Services in Johor Bahru" zh="新山专业中风康复服务" />
            </h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                <Bilingual
                  en={<>Stroke is one of the leading causes of disability in Malaysia, and access to
                  quality rehabilitation close to home can make a significant difference in
                  recovery outcomes. In Johor Bahru, Genesis Life Care provides a professional
                  stroke rehabilitation programme with experienced therapists and 24-hour nursing
                  support.</>}
                  zh="中风是马来西亚导致残疾的主要原因之一，就近获得优质的康复治疗对康复成效有着重大影响。在新山，Genesis Life Care提供专业的中风康复计划，配备经验丰富的治疗师团队及24小时护理支持。"
                />
              </p>
              <p>
                <Bilingual
                  en={<>Our comprehensive approach combines physiotherapy to rebuild strength, mobility,
                  and balance; occupational therapy to help patients regain independence in daily
                  activities; and speech and language therapy for those experiencing communication
                  or swallowing difficulties after stroke. Each rehabilitation plan is personalised
                  with clear milestones and regularly reviewed by our multidisciplinary care team.</>}
                  zh="我们全面的康复方针结合物理治疗以重建力量、活动能力与平衡；职业治疗协助病患恢复日常生活的独立能力；以及言语及语言治疗，帮助中风后出现沟通或吞咽困难的病患。每份康复计划均个性化制定，设有明确的里程碑，并由我们的多学科护理团队定期检讨。"
                />
              </p>
              <p>
                <Bilingual
                  en={<>Located at Taman Century, our Johor Bahru centre serves families across
                  JB, Skudai, Iskandar Puteri, Pasir Gudang, and the wider Johor region. With
                  {centre.beds} beds and dedicated rehabilitation facilities, we provide the
                  southern region with professional stroke recovery care. Genesis Life Care JB is
                  rated {centre.rating} stars on Google with {centre.reviews} reviews from families
                  who have entrusted us with their loved ones&apos; care.</>}
                  zh={<>我们位于Taman Century的新山中心，服务范围涵盖JB、Skudai、Iskandar Puteri、Pasir Gudang及柔佛全境的家庭。凭借{centre.beds}张床位及专属康复设施，我们为南部地区提供专业的中风康复护理。Genesis Life Care JB在Google上获得{centre.rating}星评分，共{centre.reviews}则来自信赖我们照顾挚亲家庭的评价。</>}
                />
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="A comprehensive, multidisciplinary approach to stroke recovery at our Johor Bahru centre." zh="新山中心提供全面、跨专业的中风康复方针。" />
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              <Bilingual en="Care Services at Our Johor Bahru Centre" zh="我们新山中心的护理服务" />
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="Our southern region centre with dedicated stroke rehabilitation facilities." zh="我们南部地区的中心，设有专属中风康复设施。" />
            </p>
          </div>
              ...
              <div className="p-8">
                <div className="flex items-center gap-2 mb-3">
                  <span className="bg-gold text-gray-900 text-xs font-bold px-3 py-1 rounded-full">
                    <Bilingual en="Southern Region" zh="南部地区" />
                  </span>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="Common questions about stroke rehabilitation in Johor Bahru." zh="关于新山中风康复的常见问题。" />
            </p>
          </div>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">
            <Bilingual en="Start Your Stroke Recovery Journey in Johor Bahru" zh="开启您在新山的中风康复之旅" />
          </h2>
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto" style={{ color: 'white' }}>
            <Bilingual
              en="Visit our JB centre for a free consultation. Meet our rehabilitation team
            and discover how we can help your loved one recover from stroke."
              zh="欢迎参观我们的新山中心，预约免费咨询。认识我们的康复团队，了解我们如何协助您的至亲从中风中康复。"
            />
          </p>
