...
const highlightsZh = [
  { label: '服务年资', sub: '始于2020年' },
  { label: '居民容量', sub: '舒适床位' },
  { label: zhCommon.googleRating, sub: '58则评价' },
  { label: '实惠价格', sub: '所有中心' },
  { label: '护理人员', sub: '全天候' },
];
...
const checklistZh = [
  ...
  { title: '地点与交通', desc: '我们的八打灵再也中心可轻松经由联邦大道（Federal Highway）及白蒲大道（LDP）抵达，并设有充足的访客停车位。' },
...
const admissionStepsZh = [
  ...
  { title: '免费评估与参观', desc: '参观我们的八打灵再也中心，与护理团队见面，我们将免费评估您亲人的需求。' },
...
// Page-specific — ported from the pre-Bloom CMS translation of this page (Q2, Q3 shared verbatim across every old-folks-home-in-X page).
const faqsZh = [
  {
    q: '八打灵再也老年人之家要多少钱？',
    a: 'Genesis Life Care Petaling Jaya的费用取决于所需护理的水平和房间类型。我们提供具有竞争力的价格，基本护理每月从约RM 2,500开始。根据您亲人的需求，请与我们联系获取个性化报价。',
  },
  {
    q: '老年人之家和疗养院有什么区别？',
  ...
  {
    q: 'Genesis Life Care Petaling Jaya价格合理吗？',
...
function buildJsonLd(locale: 'en' | 'zh') {
  ...
  const pageUrl = `https://genesiscare.com.my${urlPrefix}/old-folks-home-in-petaling-jaya`;
  return {
    localBusiness: {
...
// Lives outside src/app so both /old-folks-home-in-petaling-jaya/page.tsx and
// /zh/old-folks-home-in-petaling-jaya/page.tsx can import it — a Next.js
// route file (page.tsx) is only allowed to export the whitelisted route
// exports (default, metadata, revalidate, ...), so this can't live in either one.

export function OldFolksHomePetalingJayaContent({ locale = 'en' }: { locale?: 'en' | 'zh' } = {}) {
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-sm font-bold uppercase tracking-widest text-white/70 mb-3" style={{ color: 'rgba(255,255,255,0.7)' }}>
                <Bilingual en={<>Old Folks Home in {centre.name}</>} zh="八打灵再也老年人之家" />
              </p>
              <h1 className="text-4xl sm:text-5xl font-extrabold text-white leading-tight mb-6" style={{ color: 'white' }}>
                <Bilingual en={<>Best Old Folks Home<br className="hidden sm:block" /> in {centre.name}</>} zh={<>最佳老年人之家<br className="hidden sm:block" />八打灵再也</>} />
              </h1>
              <p className="text-lg text-white/90 max-w-xl mb-8 leading-relaxed" style={{ color: 'rgba(255,255,255,0.9)' }}>
                <Bilingual
                  en="A warm, home-like environment where your loved ones receive professional care with dignity and compassion. Our Petaling Jaya centre features a dedicated memory care wing, rehabilitation facilities, and a caring team available around the clock."
                  zh="一个温暖、家庭般的环境，您的亲人在这里获得尊严和同情心的专业护理。我们的八打灵再也中心拥有专门的记忆护理部门、康复设施和全天候可用的护理团队。"
                />
              </p>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2"><Bilingual en="Why Petaling Jaya" zh="为何选择八打灵再也" /></p>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-6">
                <Bilingual en="Why Choose Our Old Folks Home in Petaling Jaya?" zh="为何选择我们在八打灵再也的老年人之家？" />
              </h2>
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  <Bilingual
                    en="Finding the right old folks home for your loved one is one of the most important decisions a family can make. Our Petaling Jaya centre, located in Taman Petaling Utama along Jalan PJS 1/50, is our flagship facility — purpose-built to provide the highest standard of elderly care in the Klang Valley."
                    zh="为亲人找到合适的老年人之家，是家庭需要做出的最重要决定之一。我们位于Taman Petaling Utama、Jalan PJS 1/50的八打灵再也中心是我们的旗舰设施——专为在巴生谷提供最高水准的乐龄护理而设。"
                  />
                </p>
                <p>
                  <Bilingual
                    en="Petaling Jaya is ideal for families looking for accessible, high-quality senior care. Our centre is conveniently located near major hospitals including Sunway Medical Centre and Assunta Hospital, and is easily reachable via the Federal Highway and LDP Expressway, making family visits stress-free."
                    zh="八打灵再也非常适合寻求便利、高品质乐龄护理的家庭。我们的中心邻近双威医疗中心（Sunway Medical Centre）及安顺医院（Assunta Hospital）等主要医院，并可轻松经由联邦大道及白蒲大道抵达，让家属探访毫无压力。"
                  />
                </p>
                <p>
                  <Bilingual
                    en="What sets our PJ old folks home apart is the dedicated memory care wing — one of the few in Malaysia offering psychologist-led cognitive stimulation therapy alongside round-the-clock nursing care, rehabilitation services, and quality in-house dining."
                    zh="我们八打灵再也老年人之家的特色，在于设有专门的记忆护理部门——是马来西亚少数提供心理学家主导认知刺激疗法的中心之一，并配合全天候护理、康复服务及优质内部餐饮。"
                  />
                </p>
              </div>
              <div className="flex flex-wrap gap-2 mt-6">
                {[
                  { en: 'Near Major Hospitals', zh: '邻近主要医院' },
                  { en: 'Federal Highway Access', zh: '联邦大道直达' },
                  { en: 'LDP Expressway', zh: '白蒲大道直达' },
                  { en: 'Memory Care Wing', zh: '记忆护理部门' },
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              <Bilingual en="Beyond everyday care, our old folks home in Petaling Jaya offers a full range of specialist services." zh="除日常护理外，我们八打灵再也的老年人之家还提供全方位的专科服务。" />
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-8">
            <Link href={centre.nursingHomeSlug} className="text-primary font-semibold text-sm hover:underline">
              <Bilingual en={<>View full centre details for {centre.name} →</>} zh="查看八打灵再也完整中心详情 →" />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 py-16 sm:py-20 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4" style={{ color: 'white' }}>
            <Bilingual en={<>Visit Our Old Folks Home in {centre.name}</>} zh="参观我们在八打灵再也的老年人之家" />
          </h2>
          <p className="text-lg text-white/90 mb-8 max-w-xl mx-auto" style={{ color: 'rgba(255,255,255,0.9)' }}>
            <Bilingual
              en="Schedule a free walkthrough of our Petaling Jaya centre. Meet the team, see the facilities, and find out if we are the right home for your loved one. No obligations."
              zh="预约免费参观我们的八打灵再也中心，认识团队、了解设施，看看我们是否适合您的亲人——完全不设任何义务。"
            />
          </p>
