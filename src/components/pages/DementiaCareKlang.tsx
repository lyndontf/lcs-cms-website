...
const faqsZh = [
  {
    q: 'Genesis Life Care Klang提供哪些痴呆症护理服务？',
    a: '我们的Klang中心提供全面的痴呆症护理，包括心理学家主导的认知刺激疗法、结构化日常活动、艺术和音乐治疗、安全的环境有跌倒预防措施，以及根据每位居民的痴呆症阶段定制的个性化护理计划。',
  },
  {
    q: 'Genesis Life Care如何在Klang进行痴呆症护理？',
    a: 'Genesis Life Care在我们的Klang中心采用心理学家主导的痴呆症护理方法。我们的计划由合格的心理学家设计和监督，他们创建结构化的认知刺激活动。结合全天候护理和现场医生咨询，我们提供整体痴呆症支持。',
  },
  {
    q: '我应该寻找哪些早期痴呆症迹象？',
  ...
  {
    q: 'Klang中心对痴呆症患者安全吗？',
    a: '是的。我们的Klang中心的设计考虑到了痴呆症患者的安全。我们有安全的房舍以防止漂泊、全面的跌倒预防措施、由训练有素的护理人员进行的24小时监督，以及安全的结构化环境，帮助居民感到舒适和有方向感。',
  },
  {
    q: 'Klang的痴呆症护理费用是多少？',
    a: 'Genesis Life Care在我们的Klang中心提供经济实惠的痴呆症护理费率。费用因所需的护理水平和房间类型而异。联系我们以获取个性化报价—我们很乐意讨论适合您的家庭需求和预算的选择。',
  },
  {
    q: '家庭成员可以在Klang中心访问痴呆症患者吗？',
  ...
  '@graph': [
    {
      ...
      url: `https://genesiscare.com.my${urlPrefix}/dementia-care-in-klang`,
...
// Lives outside src/app so both /dementia-care-in-klang/page.tsx and
// /zh/dementia-care-in-klang/page.tsx can import it — a Next.js route
...
export function DementiaCareKlangContent({ locale = 'en' }: { locale?: 'en' | 'zh' } = {}) {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2" style={{ color: 'white' }}><Bilingual en="Dementia Care in Klang" zh="巴生痴呆症护理" /></p>
              <h1 className="text-4xl sm:text-5xl font-extrabold leading-[1.1] tracking-tight text-white mb-5" style={{ color: 'white' }}>
                <Bilingual en={<>Dementia Care in<br />Klang</>} zh={<>痴呆症护理<br />巴生</>} />
              </h1>
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                <Bilingual
                  en="Genesis Life Care Klang provides specialised dementia and memory care with psychologist-led programmes, 24/7 nursing supervision, and a safe, structured environment designed for residents living with dementia."
                  zh="Genesis Life Care Klang提供专业的痴呆症和记忆护理，具有心理学家主导的计划、24/7护理监督以及为痴呆症患者设计的安全、结构化环境。"
                />
              </p>
            ...
            <div className="relative hidden lg:block">
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg px-5 py-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500"><Bilingual en="Klang, Selangor" zh="巴生，雪兰莪" /></p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2"><Bilingual en="Dementia Care in Klang" zh="巴生痴呆症护理" /></p>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                <Bilingual
                  en={<>Dementia is a progressive condition that affects memory, thinking, and the ability to perform everyday activities. As Malaysia&apos;s population ages, more families in Klang and the surrounding areas are seeking professional dementia care for their loved ones.</>}
                  zh="痴呆症是一种渐进性疾病，会影响记忆力、思维能力以及执行日常活动的能力。随着马来西亚人口老龄化，越来越多巴生及周边地区的家庭正在为家中长者寻求专业的痴呆症护理。"
                />
              </p>
              <p>
                <Bilingual
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="A comprehensive, psychologist-led approach to dementia care at our Klang centre." zh="巴生中心提供全面、心理学家主导的痴呆症护理方针。" />
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              <Bilingual en="All Services at Our Klang Centre" zh="巴生中心的全部服务" />
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="Our original centre — established 2018 — specialised dementia care in Klang." zh="我们于2018年成立的首间中心——巴生的专业痴呆症护理。" />
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="Common questions about dementia care in Klang." zh="关于巴生痴呆症护理的常见问题。" />
            </p>
          </div>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">
            <Bilingual en="Specialised Dementia Care in Klang" zh="巴生专业痴呆症护理" />
          </h2>
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto" style={{ color: 'white' }}>
            <Bilingual
              en="Visit our Klang centre for a free tour. See our dementia care spaces, meet the psychologist and care team, and learn how we support families living with dementia."
              zh="欢迎参观我们的巴生中心，免费导览。了解我们的痴呆症护理空间，认识心理学家与护理团队，并了解我们如何支援与痴呆症共处的家庭。"
            />
          </p>
