...
const faqs = [
  {
    q: 'What stroke rehabilitation services are available in Kajang?',
    a: 'Genesis Life Care Kajang offers comprehensive stroke rehabilitation including physiotherapy, occupational therapy, and speech and language therapy. Our multidisciplinary team designs personalised recovery plans to help stroke survivors regain mobility, independence, and communication skills.',
  },
  {
    q: 'How soon after a stroke should rehabilitation begin?',
    a: 'Stroke rehabilitation should ideally begin as soon as the patient is medically stable, typically within 24 to 48 hours after the stroke. Early rehabilitation has been shown to significantly improve recovery outcomes. Our team works closely with hospitals in the Kajang and Bangi area to ensure a smooth transition into our rehab programme.',
  },
  {
    q: 'How long does stroke rehabilitation take at Genesis Life Care Kajang?',
  ...
  {
    q: 'Does Genesis Life Care Kajang provide speech therapy for stroke patients?',
    a: 'Yes, our Kajang centre provides speech and language therapy as part of our stroke rehabilitation programme. This includes therapy for communication difficulties such as aphasia, as well as swallowing therapy for patients with dysphagia following a stroke.',
  },
  {
    q: 'How much does stroke rehabilitation cost in Kajang?',
...
const faqsZh = [
  {
    q: '加影提供哪些中风康复服务？',
    a: 'Genesis Life Care加影提供全面的中风康复，包括物理治疗、职业治疗和言语及语言治疗。我们的多学科团队为中风幸存者设计个性化康复计划，帮助他们恢复活动能力、独立性和沟通技能。',
  },
  {
    q: '中风后多久应该开始康复？',
    a: '中风康复应在患者医学稳定后尽快开始，通常在中风后24至48小时内。早期康复已被证明能显著改善康复预后。我们的团队与加影和班吉地区的医院密切合作，确保顺利进入我们的康复项目。',
  },
  {
    q: 'Genesis Life Care加影的中风康复需要多长时间？',
    a: '中风康复的持续时间取决于中风的严重程度和个人恢复进度。一些患者在数周内看到显著改善，而其他患者可能需要数月的治疗。我们设定个性化里程碑并定期重新评估每位患者的计划。',
  },
  {
    q: 'Genesis Life Care加影为中风患者提供言语治疗吗？',
    a: '是的，我们的加影中心提供言语和语言治疗，作为中风康复项目的一部分。这包括治疗失语症等沟通困难，以及中风后吞咽困难患者的吞咽治疗。',
  },
  {
    q: '加影的中风康复费用是多少？',
  ...
  '@graph': [
    {
      ...
      description: 'Professional stroke rehabilitation centre in Kajang offering physiotherapy, occupational therapy, and speech therapy for stroke recovery.',
      url: `https://genesiscare.com.my${urlPrefix}/stroke-rehabilitation-in-kajang`,
      ...
      areaServed: { '@type': 'City', name: 'Kajang' },
      aggregateRating: {
...
// Lives outside src/app so both /stroke-rehabilitation-in-kajang/page.tsx
// and /zh/stroke-rehabilitation-in-kajang/page.tsx can import it — a
...
export function StrokeRehabilitationKajangContent({ locale = 'en' }: { locale?: 'en' | 'zh' } = {}) {
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                <Bilingual
                  ...
                  plans and 24-hour nursing support in our spacious {centre.beds} bed facility.</>}
                  zh={<>Genesis Life Care加影提供全面的中风康复，包括物理治疗、职业治疗和言语治疗。我们专业的团队协助中风幸存者透过个性化康复计划和24小时护理支持，在我们宽敞的{centre.beds}张床位设施中恢复独立性。</>}
                />
              </p>
            ...
            <div className="relative hidden lg:block">
              <div className="rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
                <img
                  src={centre.img}
                  alt="Stroke Rehabilitation Centre in Kajang — Genesis Life Care"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
              <Bilingual en="Expert Stroke Recovery Services in Kajang" zh="加影专业中风康复服务" />
            </h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                <Bilingual
                  en={<>Stroke recovery is a journey that requires dedicated, professional support from
                  day one. In Kajang and the southern Klang Valley, Genesis Life Care provides a
                  structured stroke rehabilitation programme designed to maximise recovery potential
                  for every patient.</>}
                  zh="中风康复是一段从第一天起就需要专业悉心支持的旅程。在加影及南巴生谷地区，Genesis Life Care提供结构化的中风康复计划，致力为每位病患发挥最大的康复潜能。"
                />
              </p>
              <p>
                <Bilingual
                  en={<>Our multidisciplinary approach brings together physiotherapy to rebuild strength
                  and coordination, occupational therapy to help patients regain confidence in
                  daily activities, and speech and language therapy for those affected by
                  communication or swallowing challenges. Every patient receives an individualised
                  recovery plan with measurable milestones reviewed regularly by our care team.</>}
                  zh="我们的多学科方针结合物理治疗以重建力量与协调能力、职业治疗协助病患重拾日常活动的信心，以及言语及语言治疗协助受沟通或吞咽困难影响的病患。每位病患都会获得个性化的康复计划，设有可衡量的里程碑，并由我们的护理团队定期检讨。"
                />
              </p>
              <p>
                <Bilingual
                  en={<>Our Kajang centre at Kawasan Perindustrian Ria serves families from Kajang, Bangi, Semenyih,
                  and surrounding areas. With {centre.beds} beds and round-the-clock nursing care,
                  we provide a comfortable and supportive environment for stroke recovery. Genesis
                  Life Care Kajang is rated {centre.rating} stars on Google with {centre.reviews} reviews
                  from families who trust us with their loved ones.</>}
                  zh={<>我们位于Kawasan Perindustrian Ria的加影中心，服务来自加影、Bangi、Semenyih及周边地区的家庭。凭借{centre.beds}张床位及全天候护理服务，我们为中风康复提供舒适且具支持性的环境。Genesis Life Care加影在Google上获得{centre.rating}星评分，共{centre.reviews}则来自信赖我们照顾挚亲家庭的评价。</>}
                />
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="A comprehensive, multidisciplinary approach to stroke recovery at our Kajang centre." zh="加影中心提供全面、跨专业的中风康复方针。" />
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              <Bilingual en="Care Services at Our Kajang Centre" zh="我们加影中心的护理服务" />
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              <Bilingual en="Visit Our Kajang Centre" zh="参观我们的加影中心" />
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="Serving the southern Klang Valley with dedicated stroke rehabilitation facilities." zh="服务南巴生谷地区，设有专属中风康复设施。" />
            </p>
          </div>
              ...
              <div className="p-8">
                <div className="flex items-center gap-2 mb-3">
                  <span className="bg-gold text-gray-900 text-xs font-bold px-3 py-1 rounded-full">
                    <Bilingual en="Southern KV" zh="南巴生谷" />
                  </span>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="Common questions about stroke rehabilitation in Kajang." zh="关于加影中风康复的常见问题。" />
            </p>
          </div>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">
            <Bilingual en="Start Your Stroke Recovery Journey in Kajang" zh="开启您在加影的中风康复之旅" />
          </h2>
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto" style={{ color: 'white' }}>
            <Bilingual
              en="Visit our Kajang centre for a free consultation. Meet our rehabilitation team
            and discover how we can help your loved one recover from stroke."
              zh="欢迎参观我们的加影中心，预约免费咨询。认识我们的康复团队，了解我们如何协助您的至亲从中风中康复。"
            />
          </p>
