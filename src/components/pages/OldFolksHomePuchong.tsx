...
const centre = {
  ...
  nursingHomeSlug: '/nursing-home-in-puchong',
  lat: 3.0245,
  lng: 101.6175,
};
...
const highlightsZh = [
  { label: '服务年资', sub: '始于2022年' },
  { label: '居民容量', sub: '舒适床位' },
  { label: zhCommon.googleRating, sub: '38则评价' },
  { label: '实惠价格', sub: '所有中心' },
  { label: '护理人员', sub: '全天候' },
];
...
const checklist = [
  ...
  { title: 'Location & Accessibility', desc: 'Our Puchong centre in Bandar Puteri is easily accessible via LDP Expressway and ELITE Highway, with ample parking for visitors.' },
...
const checklistZh = [
  ...
  { title: '地点与交通', desc: '我们位于Bandar Puteri的蒲种中心可轻松经由白蒲大道（LDP）及ELITE大道抵达，并设有充足的访客停车位。' },
...
const admissionSteps = [
  ...
  { step: '2', title: 'Free Assessment & Tour', desc: 'Visit our Puchong centre, meet the care team, and we will assess your loved one\'s needs at no charge.' },
...
const admissionStepsZh = [
  ...
  { title: '免费评估与参观', desc: '参观我们的蒲种中心，与护理团队见面，我们将免费评估您亲人的需求。' },
  { title: '迁入', desc: '当您准备就绪后，我们将制定个性化护理计划，协助您的亲人舒适地安顿于新家。' },
];

const faqs = [
  {
    q: 'How much does an old folks home cost in Puchong?',
...
// centre-name substitution); Q1 and Q4 are page-specific — adapted from the
...
// terminology for consistency with every other page. Note: unlike Klang/Kajang,
// this page's English FAQ list has never included a "personal belongings"
// question — kept at 4 FAQs to match.
const faqsZh = [
  {
    q: '蒲种老年人之家要多少钱？',
    a: 'Genesis Life Care Puchong的费用取决于所需护理的水平和房间类型。我们为Bandar Puteri的中心提供具有竞争力的价格。根据您亲人的需求，请与我们联系获取个性化报价。',
  },
  {
    q: '老年人之家和疗养院有什么区别？',
  ...
  {
    q: 'Genesis Life Care Puchong价格合理吗？',
...
function buildJsonLd(locale: 'en' | 'zh') {
  ...
  const pageUrl = `https://genesiscare.com.my${urlPrefix}/old-folks-home-in-puchong`;
  return {
    localBusiness: {
      ...
      description: 'Modern old folks home in Puchong, Bandar Puteri with 24/7 nursing care, rehabilitation and dementia care.',
      url: pageUrl,
...
// Lives outside src/app so both /old-folks-home-in-puchong/page.tsx and
// /zh/old-folks-home-in-puchong/page.tsx can import it — a Next.js route
...
export function OldFolksHomePuchongContent({ locale = 'en' }: { locale?: 'en' | 'zh' } = {}) {
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-sm font-bold uppercase tracking-widest text-white/70 mb-3" style={{ color: 'rgba(255,255,255,0.7)' }}>
                <Bilingual en={<>Old Folks Home in {centre.name}</>} zh="蒲种老年人之家" />
              </p>
              <h1 className="text-4xl sm:text-5xl font-extrabold text-white leading-tight mb-6" style={{ color: 'white' }}>
                <Bilingual en={<>Best Old Folks Home<br className="hidden sm:block" /> in {centre.name}</>} zh={<>最佳老年人之家<br className="hidden sm:block" />蒲种</>} />
              </h1>
              <p className="text-lg text-white/90 max-w-xl mb-8 leading-relaxed" style={{ color: 'rgba(255,255,255,0.9)' }}>
                <Bilingual
                  en="A modern, purpose-built facility where your loved ones receive professional care with dignity and compassion. Our Puchong centre in Bandar Puteri features rehabilitation facilities, nutritious meals, and a caring team available around the clock."
                  zh="一个现代化、专门建造的设施，让您的亲人在此获得尊严与关怀兼备的专业护理。我们位于Bandar Puteri的蒲种中心设有康复设施、营养膳食，以及全天候待命的护理团队。"
                />
              </p>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2"><Bilingual en="Why Puchong" zh="为何选择蒲种" /></p>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-6">
                <Bilingual en="Why Choose Our Old Folks Home in Puchong?" zh="为何选择我们在蒲种的老年人之家？" />
              </h2>
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  <Bilingual
                    en="Located in Bandar Puteri, one of Puchong's most well-established and family-friendly townships, our modern facility offers contemporary amenities and purpose-built spaces designed for elderly comfort. Genesis Life Care Puchong is ideal for families seeking high-quality senior care in a convenient, accessible location."
                    zh="我们的蒲种中心坐落于Bandar Puteri，是蒲种最成熟、最适合家庭居住的社区之一，现代化设施与专门设计的空间，为长者提供舒适的生活环境。Genesis Life Care Puchong非常适合寻求优质乐龄护理、且重视交通便利的家庭。"
                  />
                </p>
                <p>
                  <Bilingual
                    en="What sets our Puchong old folks home apart is the combination of round-the-clock nursing care, nutritious meals, rehabilitation services, dedicated activities, and dementia support — ensuring your loved one receives holistic care in a comfortable, respectful environment."
                    zh="我们蒲种老年人之家的特色，在于全天候护理、营养膳食、康复服务、专属活动及痴呆症支援的完美结合——确保您的亲人在舒适、备受尊重的环境中获得全方位的照护。"
                  />
                </p>
                <p>
                  <Bilingual
                    en="Easy highway access via the LDP Expressway and ELITE Highway makes our centre central to many Klang Valley families. We are near Columbia Asia Hospital Puchong and KPJ Damansara Specialist Hospital, and ideal for families from Puchong, Subang Jaya, USJ, Cyberjaya, and Putrajaya."
                    zh="经由白蒲大道（LDP）及ELITE大道即可轻松抵达，让我们的中心成为许多巴生谷家庭的理想之选。我们邻近哥伦比亚亚洲医院蒲种分院（Columbia Asia Hospital Puchong）及KPJ白沙罗专科医院，非常适合来自蒲种、梳邦再也、USJ、赛城及布城的家庭。"
                  />
                </p>
              </div>
              <div className="flex flex-wrap gap-2 mt-6">
                {[
                  { en: 'Modern Facility', zh: '现代化设施' },
                  { en: 'Quality Dining', zh: '优质餐饮' },
                  { en: 'LDP & ELITE Access', zh: 'LDP与ELITE大道直达' },
                  { en: 'Bandar Puteri', zh: 'Bandar Puteri' },
                  { en: 'Near Hospitals', zh: '邻近医院' },
                ].map((t) => (
            ...
            <div>
              <img
                ...
                alt="Common area at our old folks home in Puchong"
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              <Bilingual en="Beyond everyday care, our old folks home in Puchong offers a full range of specialist services." zh="除日常护理外，我们蒲种的老年人之家还提供全方位的专科服务。" />
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-8">
            <Link href={centre.nursingHomeSlug} className="text-primary font-semibold text-sm hover:underline">
              <Bilingual en={<>View full centre details for {centre.name} →</>} zh="查看蒲种完整中心详情 →" />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 py-16 sm:py-20 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4" style={{ color: 'white' }}>
            <Bilingual en={<>Visit Our Old Folks Home in {centre.name}</>} zh="参观我们在蒲种的老年人之家" />
          </h2>
          <p className="text-lg text-white/90 mb-8 max-w-xl mx-auto" style={{ color: 'rgba(255,255,255,0.9)' }}>
            <Bilingual
              en="Schedule a free walkthrough of our Puchong centre. Meet the team, see the facilities, and find out if we are the right home for your loved one. No obligations."
              zh="预约免费参观我们的蒲种中心，认识团队、了解设施，看看我们是否适合您的亲人——完全不设任何义务。"
            />
          </p>
