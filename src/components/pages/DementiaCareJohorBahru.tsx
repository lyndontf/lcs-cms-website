...
const faqs = [
  ...
  {
    q: 'How much does dementia care cost in Johor Bahru?',
    a: 'Genesis Life Care offers affordable dementia care rates at our JB centre. Costs vary based on the level of care required and room type. Contact us for a personalised quotation — we are happy to discuss options that suit your family\'s needs and budget.',
  },
  {
...
const faqsZh = [
  {
    q: 'Genesis Life Care Johor Bahru提供哪些痴呆症护理服务？',
    a: '我们的Johor Bahru中心提供全面的痴呆症护理，包括心理学家主导的认知刺激疗法、结构化日常活动、艺术和音乐治疗、安全的环境有跌倒预防措施，以及根据每位居民的痴呆症阶段定制的个性化护理计划。',
  },
  {
    q: 'Genesis Life Care如何在JB进行痴呆症护理？',
    a: 'Genesis Life Care在我们的JB中心采用心理学家主导的痴呆症护理方法。我们的计划由合格的心理学家设计和监督，他们创建结构化的认知刺激活动。结合全天候护理和现场医生咨询，我们提供整体痴呆症支持。',
  },
  {
    q: '我应该寻找哪些早期痴呆症迹象？',
  ...
  {
    q: 'Johor Bahru中心对痴呆症患者安全吗？',
    a: '是的。我们的JB中心为痴呆症患者的安全而设计。我们有安全的房舍以防止漂泊、全面的跌倒预防措施、由训练有素的护理人员进行的24小时监督，以及安全的结构化环境，帮助居民感到舒适和有方向感。',
  },
  {
    q: 'Johor Bahru的痴呆症护理费用是多少？',
    a: 'Genesis Life Care在我们的JB中心提供经济实惠的痴呆症护理费率。费用因所需的护理水平和房间类型而异。联系我们以获取个性化报价—我们很乐意讨论适合您的家庭需求和预算的选择。',
  },
  {
    q: 'Genesis Life Care在Johor为哪些地区提供痴呆症护理？',
    a: '我们的Johor Bahru中心为Johor各地的家庭服务，包括Johor Bahru市、Iskandar Puteri、Skudai、Kulai、Pasir Gudang、Masai及周边地区。我们方便地位于Taman Century，易于通过高速公路进入。',
  },
];
  ...
  '@graph': [
    {
      ...
      url: `https://genesiscare.com.my${urlPrefix}/dementia-care-in-johor-bahru`,
...
// Lives outside src/app so both /dementia-care-in-johor-bahru/page.tsx and
// /zh/dementia-care-in-johor-bahru/page.tsx can import it — a Next.js route
...
export function DementiaCareJBContent({ locale = 'en' }: { locale?: 'en' | 'zh' } = {}) {
    ...
    <main className="bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2" style={{ color: 'white' }}><Bilingual en="Dementia Care in Johor Bahru" zh="新山痴呆症护理" /></p>
              <h1 className="text-4xl sm:text-5xl font-extrabold leading-[1.1] tracking-tight text-white mb-5" style={{ color: 'white' }}>
                <Bilingual en={<>Dementia Care in<br />Johor Bahru</>} zh={<>痴呆症护理<br />新山</>} />
              </h1>
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                <Bilingual
                  en="Genesis Life Care Johor Bahru provides specialised dementia and memory care with psychologist-led programmes, 24/7 nursing supervision, and a safe, structured environment — serving families across JB, Iskandar Puteri, Skudai, and surrounding areas."
                  zh="Genesis Life Care Johor Bahru提供专业的痴呆症和记忆护理，具有心理学家主导的计划、24/7护理监督以及安全、结构化的环境，为JB、Iskandar Puteri、Skudai及周边地区的家庭服务。"
                />
              </p>
            ...
            <div className="relative hidden lg:block">
              <div className="rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
                <img src={centre.img} alt="Genesis Life Care Johor Bahru — dementia care centre" className="w-full h-[420px] object-cover" />
              </div>
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg px-5 py-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500"><Bilingual en="Johor Bahru, Johor" zh="新山，柔佛" /></p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2"><Bilingual en="Dementia Care in Johor Bahru" zh="新山痴呆症护理" /></p>
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                <Bilingual
                  en={<>Dementia is a progressive condition that affects memory, thinking, and the ability to perform everyday activities. As Malaysia&apos;s population ages, more families in Johor Bahru, Iskandar Puteri, Skudai, and across Johor are seeking professional dementia care for their loved ones.</>}
                  zh="痴呆症是一种渐进性疾病，会影响记忆力、思维能力以及执行日常活动的能力。随着马来西亚人口老龄化，越来越多新山、依斯干达公主城、士古来及柔佛各地的家庭正在为家中长者寻求专业的痴呆症护理。"
                />
              </p>
              <p>
                <Bilingual
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto"><Bilingual en="A comprehensive, psychologist-led approach to dementia care at our Johor Bahru centre." zh="新山中心提供全面、心理学家主导的痴呆症护理方针。" /></p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900"><Bilingual en="All Services at Our Johor Bahru Centre" zh="新山中心的全部服务" /></h2>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900"><Bilingual en="Visit Our Johor Bahru Centre" zh="参观我们的新山中心" /></h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto"><Bilingual en="Serving families across Johor — specialised dementia care in JB." zh="服务柔佛各地家庭——新山的专业痴呆症护理。" /></p>
          </div>
            ...
            <div className="grid md:grid-cols-2">
              ...
              <div className="p-8">
                <div className="flex items-center gap-2 mb-3">
                  <span className="bg-gold text-gray-900 text-xs font-bold px-3 py-1 rounded-full"><Bilingual en="Johor Centre" zh="柔佛中心" /></span>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto"><Bilingual en="Common questions about dementia care in Johor Bahru." zh="关于新山痴呆症护理的常见问题。" /></p>
          </div>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4"><Bilingual en="Specialised Dementia Care in Johor Bahru" zh="新山专业痴呆症护理" /></h2>
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto" style={{ color: 'white' }}>
            <Bilingual
              en="Visit our JB centre for a free tour. See our dementia care spaces, meet the psychologist and care team, and learn how we support families living with dementia."
              zh="欢迎参观我们的新山中心，免费导览。了解我们的痴呆症护理空间，认识心理学家与护理团队，并了解我们如何支援与痴呆症共处的家庭。"
            />
          </p>
