            ...
            <div>
              ...
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                <Bilingual
                  ...
                  zh={<>孟沙的家庭信赖Genesis Life Care提供优质的养老院服务。我们的Petaling Jaya中心距离仅{nearestCentre.distance}——提供24/7护理、现场医生咨询、失智症护理以及全面的康复服务。</>}
                />
              </p>
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual
                ...
                zh={<>距孟沙仅{nearestCentre.distance}——我们位于Kota Damansara的旗舰中心。</>}
              />
            </p>
          </div>
