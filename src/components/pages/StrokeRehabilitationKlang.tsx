...
const faqs = [
  ...
  {
    q: 'How much does stroke rehabilitation cost in Klang?',
...
const faqsZh = [
  {
    q: '巴生提供哪些中风康复服务？',
    a: 'Genesis Life Care巴生提供全面的中风康复，包括物理治疗、职业治疗和言语及语言治疗。我们的多学科团队为中风幸存者设计个性化康复计划，帮助他们恢复活动能力、独立性和沟通技能。',
  },
  {
    q: '中风后多久应该开始康复？',
    a: '中风康复应在患者医学稳定后尽快开始，通常在中风后24至48小时内。早期康复已被证明能显著改善康复预后。我们的团队与巴生地区的医院密切合作，确保顺利进入我们的康复项目。',
  },
  {
    q: 'Genesis Life Care巴生的中风康复需要多长时间？',
    a: '中风康复的持续时间取决于中风的严重程度和个人恢复进度。一些患者在数周内看到显著改善，而其他患者可能需要数月的治疗。我们设定个性化里程碑并定期重新评估每位患者的计划。',
  },
  {
    q: 'Genesis Life Care巴生为中风患者提供言语治疗吗？',
    a: '是的，我们的巴生中心提供言语和语言治疗，作为中风康复项目的一部分。这包括治疗失语症等沟通困难，以及中风后吞咽困难患者的吞咽治疗。',
  },
  {
    q: '巴生的中风康复费用是多少？',
...
const sharedCentre = centres['klang'];
  ...
  '@graph': [
    {
      ...
      url: `https://genesiscare.com.my${urlPrefix}/stroke-rehabilitation-in-klang`,
      ...
      areaServed: { '@type': 'City', name: 'Klang' },
      aggregateRating: {
...
// Lives outside src/app so both /stroke-rehabilitation-in-klang/page.tsx
// and /zh/stroke-rehabilitation-in-klang/page.tsx can import it — a
...
export function StrokeRehabilitationKlangContent({ locale = 'en' }: { locale?: 'en' | 'zh' } = {}) {
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                <Bilingual
                  ...
                  plans and 24-hour nursing support in our 120+ bed facility.</>}
                  zh="Genesis Life Care巴生提供全面的中风康复，包括物理治疗、职业治疗和言语治疗。我们经验丰富的团队协助中风幸存者透过个性化康复计划和24小时护理支持，在我们120+张床位的设施中恢复独立性。"
                />
              </p>
            ...
            <div className="relative hidden lg:block">
              <div className="rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
                <img
                  src={centre.img}
                  alt="Stroke Rehabilitation Centre in Klang — Genesis Life Care"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
              <Bilingual en="Expert Stroke Recovery Services in Klang" zh="巴生专业中风康复服务" />
            </h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                <Bilingual
                  en={<>Recovering from a stroke requires specialised, consistent rehabilitation from a
                  team of experienced professionals. In the Klang district, Genesis Life Care
                  provides a structured stroke rehabilitation programme designed to help patients
                  regain as much function and independence as possible.</>}
                  zh="从中风中康复需要一支经验丰富的专业团队提供专业且持续的康复治疗。在巴生地区，Genesis Life Care提供结构化的中风康复计划，协助病患尽可能恢复身体机能与独立能力。"
                />
              </p>
              <p>
                <Bilingual
                  ...
                  for those experiencing communication or swallowing difficulties. Each patient
                  receives a personalised recovery plan with clear milestones monitored by our
                  multidisciplinary team of therapists, nurses, and doctors.</>}
                  zh="我们的方针结合物理治疗以恢复活动能力与平衡、职业治疗协助病患重新学习日常活动，以及言语及语言治疗协助有沟通或吞咽困难的病患。每位病患都会获得个性化康复计划，设有明确的里程碑，并由我们的治疗师、护士及医生组成的多学科团队监督进度。"
                />
              </p>
              <p>
                <Bilingual
                  en={<>Genesis Life Care Klang is our original centre, located at Amverton Business Centre
                  with over {centre.beds} beds and 24-hour nursing care. We serve families across
                  the Klang district, Port Klang, Shah Alam, and surrounding areas. Our centre is
                  rated {centre.rating} stars on Google with {centre.reviews} reviews from families
                  who have trusted us with their loved ones&apos; recovery.</>}
                  zh={<>Genesis Life Care巴生是我们的首间中心，位于Amverton Business Centre，设有超过{centre.beds}张床位及24小时护理服务。我们服务巴生地区、Port Klang、Shah Alam及周边地区的家庭。我们的中心在Google上获得{centre.rating}星评分，共{centre.reviews}则来自信赖我们照顾挚亲康复的家庭评价。</>}
                />
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="A comprehensive, multidisciplinary approach to stroke recovery at our Klang centre." zh="巴生中心提供全面、跨专业的中风康复方针。" />
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              <Bilingual en="Care Services at Our Klang Centre" zh="我们巴生中心的护理服务" />
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              <Bilingual en="Visit Our Klang Centre" zh="参观我们的巴生中心" />
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="Our original centre in Klang with dedicated stroke rehabilitation facilities." zh="我们位于巴生的首间中心，设有专属中风康复设施。" />
            </p>
          </div>
              ...
              <div className="p-8">
                <div className="flex items-center gap-2 mb-3">
                  <span className="bg-gold text-gray-900 text-xs font-bold px-3 py-1 rounded-full">
                    <Bilingual en="Original Centre" zh="首间中心" />
                  </span>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="Common questions about stroke rehabilitation in Klang." zh="关于巴生中风康复的常见问题。" />
            </p>
          </div>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">
            <Bilingual en="Start Your Stroke Recovery Journey in Klang" zh="开启您在巴生的中风康复之旅" />
          </h2>
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto" style={{ color: 'white' }}>
            <Bilingual
              en="Visit our Klang centre for a free consultation. Meet our rehabilitation team
            and discover how we can help your loved one recover from stroke."
              zh="欢迎参观我们的巴生中心，预约免费咨询。认识我们的康复团队，了解我们如何协助您的至亲从中风中康复。"
            />
          </p>
