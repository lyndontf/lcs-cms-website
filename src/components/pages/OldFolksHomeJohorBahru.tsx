...
const centre = {
  ...
  nursingHomeSlug: '/nursing-home-in-johor-bahru',
  lat: 1.4655,
  lng: 103.7414,
};
...
const highlightsZh = [
  { label: '服务年资', sub: '始于2023年' },
  { label: '居民容量', sub: '舒适床位' },
  { label: zhCommon.googleRating, sub: '24则评价' },
  { label: '实惠价格', sub: '所有中心' },
  { label: '护理人员', sub: '全天候' },
];
...
const checklistZh = [
  ...
  { title: '地点与交通', desc: '我们位于Jalan Dato Sulaiman、Holiday Plaza的新山中心是当地知名地标，从新山各地及依斯干达马来西亚均可轻松抵达。' },
...
const admissionSteps = [
  ...
  { step: '2', title: 'Free Assessment & Tour', desc: 'Visit our Johor Bahru centre, meet the care team, and we will assess your loved one\'s needs at no charge.' },
...
const admissionStepsZh = [
  ...
  { title: '免费评估与参观', desc: '参观我们的新山中心，与护理团队见面，我们将免费评估您亲人的需求。' },
  { title: '迁入', desc: '当您准备就绪后，我们将制定个性化护理计划，协助您的亲人舒适地安顿于新家。' },
];

const faqs = [
  {
    q: 'How much does an old folks home cost in Johor Bahru?',
    a: 'Costs at Genesis Life Care Johor Bahru vary depending on the level of care required and room type. Johor Bahru offers a cost-of-living advantage compared to the Klang Valley, making quality elderly care more affordable. Contact us for a personalised quote based on your loved one\'s needs.',
  },
  {
  ...
  {
    q: 'Is Genesis Life Care Johor Bahru affordable?',
  ...
  {
    q: 'Can families from Singapore place their parents at this old folks home?',
    a: 'Yes. We serve many Malaysian and Singaporean families who prefer having their elderly parents cared for in Johor Bahru. Our proximity to the Singapore border makes it convenient for cross-border visits, and our care standards meet the expectations of families from both countries.',
  },
  {
    q: 'What are visiting hours at the JB old folks home?',
...
// Page-specific — ported from the pre-Bloom CMS translation of this page (Q2, Q3, Q5 shared verbatim across every old-folks-home-in-X page).
const faqsZh = [
  {
    q: '新山老年人之家要多少钱？',
    a: 'Genesis Life Care Johor Bahru的费用取决于所需护理的水平和房间类型。新山相比巴生谷提供了生活成本优势，使高质量的老年护理更加经济实惠。根据您亲人的需求，请与我们联系获取个性化报价。',
  },
  {
    q: '老年人之家和疗养院有什么区别？',
  ...
  {
    q: 'Genesis Life Care Johor Bahru价格合理吗？',
    a: '是的。我们提供所有中心之间的竞争性和透明价格。我们的团队与每个家庭合作，推荐适合其需求和预算的护理计划。请与我们联系获取个性化报价。',
  },
  {
    q: '新加坡的家庭可以将父母安置在这间老年人之家吗？',
    a: '可以。我们服务许多马来西亚和新加坡家庭，他们更喜欢在新山照顾他们的年迈父母。我们靠近新加坡边境，使跨境访问非常便利，我们的护理标准符合来自两个国家家庭的期望。',
  },
  {
    q: 'JB老年人之家的访问时间是什么？',
...
const otherHomes = [
  ...
  { name: 'Klang', nameZh: '巴生', slug: 'old-folks-home-in-klang', rating: '4.8', tag: 'Original Centre', tagZh: '首间中心', img: '/images/klang-centre.jpg' },
  { name: 'Kajang', nameZh: '加影', slug: 'old-folks-home-in-kajang', rating: '4.7', tag: 'Southern KV', tagZh: '南巴生谷', img: '/images/kajang-centre.jpeg' },
...
function buildJsonLd(locale: 'en' | 'zh') {
  ...
  const pageUrl = `https://genesiscare.com.my${urlPrefix}/old-folks-home-in-johor-bahru`;
  return {
    localBusiness: {
      ...
      description: 'Premier old folks home in Johor Bahru with 24/7 nursing care, dementia care, rehabilitation and nutritious meals.',
      url: pageUrl,
...
// Lives outside src/app so both /old-folks-home-in-johor-bahru/page.tsx and
// /zh/old-folks-home-in-johor-bahru/page.tsx can import it — a Next.js route
...
export function OldFolksHomeJohorBahruContent({ locale = 'en' }: { locale?: 'en' | 'zh' } = {}) {
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              ...
              <p className="text-sm font-bold uppercase tracking-widest text-white/70 mb-3" style={{ color: 'rgba(255,255,255,0.7)' }}>
                <Bilingual en={<>Old Folks Home in {centre.name}</>} zh="新山老年人之家" />
              </p>
              <h1 className="text-4xl sm:text-5xl font-extrabold text-white leading-tight mb-6" style={{ color: 'white' }}>
                <Bilingual en={<>Best Old Folks Home<br className="hidden sm:block" /> in {centre.name}</>} zh={<>最佳老年人之家<br className="hidden sm:block" />新山</>} />
              </h1>
              <p className="text-lg text-white/90 max-w-xl mb-8 leading-relaxed" style={{ color: 'rgba(255,255,255,0.9)' }}>
                <Bilingual
                  en="A warm, home-like environment where your loved ones receive professional care with dignity and compassion. Our Johor Bahru centre at Holiday Plaza features dementia care programmes, rehabilitation facilities, and a caring team available around the clock."
                  zh="一个温暖、家庭般的环境，您的亲人在这里获得尊严和同情心的专业护理。我们位于Holiday Plaza的新山中心拥有痴呆症护理计划、康复设施和全天候可用的护理团队。"
                />
              </p>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2"><Bilingual en="Why Johor Bahru" zh="为何选择新山" /></p>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-6">
                <Bilingual en="Why Choose Our Old Folks Home in Johor Bahru?" zh="为何选择我们在新山的老年人之家？" />
              </h2>
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  <Bilingual
                    en="Genesis Life Care Johor Bahru is our first centre outside the Klang Valley, bringing the same trusted care standards that families across Malaysia have come to rely on to the southern region. Located at Holiday Plaza on Jalan Dato Sulaiman, a well-known landmark in central Johor Bahru, our centre is purpose-built to provide the highest standard of elderly care."
                    zh="Genesis Life Care新山中心是我们在巴生谷以外设立的第一间中心，将马来西亚各地家庭所信赖的护理水准延伸至南部地区。中心坐落于新山市中心著名地标——Jalan Dato Sulaiman的Holiday Plaza，专为提供最高水准的乐龄护理而设。"
                  />
                </p>
                <p>
                  <Bilingual
                    en="We serve families across JB, Iskandar Malaysia, Skudai, Kulai, and surrounding areas. Our centre is conveniently located near Hospital Sultanah Aminah and other major Johor Bahru healthcare facilities, ensuring quick access to specialist medical support when needed."
                    zh="我们服务新山、依斯干达马来西亚、士古来、古来及周边地区的家庭。中心邻近苏丹娜阿米娜医院（Hospital Sultanah Aminah）及新山其他主要医疗机构，确保在需要时能迅速获得专科医疗支援。"
                  />
                </p>
                <p>
                  <Bilingual
                    en="Our JB old folks home also serves Malaysian families from Singapore who want their elderly parents cared for nearby. With a full range of specialist care including dementia programmes, rehabilitation services, and nutritious meals, residents receive comprehensive, personalised care under one roof."
                    zh="我们的新山老年人之家也为希望将年迈父母安置在附近的马来西亚及新加坡家庭提供服务。凭借痴呆症护理计划、康复服务及营养膳食等全方位专科护理，居民可在同一屋檐下获得全面、个性化的照顾。"
                  />
                </p>
              </div>
              <div className="flex flex-wrap gap-2 mt-6">
                {[
                  { en: 'Southern Region', zh: '南部地区' },
                  { en: 'Holiday Plaza', zh: 'Holiday Plaza' },
                  { en: 'Near HSA Hospital', zh: '靠近苏丹娜阿米娜医院' },
                  { en: 'Serves JB & Iskandar', zh: '服务新山与依斯干达' },
            ...
            <div>
              <img
                ...
                alt="Common area at our old folks home in Johor Bahru"
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto">
              <Bilingual en="Beyond everyday care, our old folks home in Johor Bahru offers a full range of specialist services." zh="除日常护理外，我们新山的老年人之家还提供全方位的专科服务。" />
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mt-8">
            <Link href={centre.nursingHomeSlug} className="text-primary font-semibold text-sm hover:underline">
              <Bilingual en={<>View full centre details for {centre.name} →</>} zh="查看新山完整中心详情 →" />
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 py-16 sm:py-20 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4" style={{ color: 'white' }}>
            <Bilingual en={<>Visit Our Old Folks Home in {centre.name}</>} zh="参观我们在新山的老年人之家" />
          </h2>
          <p className="text-lg text-white/90 mb-8 max-w-xl mx-auto" style={{ color: 'rgba(255,255,255,0.9)' }}>
            <Bilingual
              en="Schedule a free walkthrough of our Johor Bahru centre. Meet the team, see the facilities, and find out if we are the right home for your loved one. No obligations."
              zh="预约免费参观我们的新山中心，认识团队、了解设施，看看我们是否适合您的亲人——完全不设任何义务。"
            />
          </p>
