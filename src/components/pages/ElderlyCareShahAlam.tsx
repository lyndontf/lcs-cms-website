...
const faqs = [
  {
    q: 'Is there a nursing home near Shah Alam?',
    a: 'Yes. Genesis Life Care Klang is located at Amverton Business Centre, Klang, approximately 10 minutes from Shah Alam via Federal Route 2. We offer 24/7 nursing care, dementia programmes, and stroke rehabilitation services.',
  },
  {
    q: 'How much does elderly care cost near Shah Alam?',
  ...
  {
    q: 'What services are available for elderly residents from Shah Alam?',
    a: 'Our Klang centre provides elderly nursing care, dementia and memory care, stroke rehabilitation, palliative care, post-operative recovery, and senior daycare programmes. All services include on-site doctor consultations.',
  },
  {
    q: 'Can I visit the nursing home near Shah Alam before committing?',
    a: 'Absolutely. We encourage families to book a free tour of our Klang facility. You can see the living spaces, meet the care team, and ask any questions — with no obligations.',
  },
  {
    q: 'How do I get to Genesis Life Care Klang from Shah Alam?',
    a: 'Our Klang centre is easily accessible from Shah Alam via Federal Route 2 (Jalan Klang-Shah Alam). The drive typically takes about 10 minutes. The centre is located at Amverton Business Centre on Jalan Istana, Klang.',
  },
  {
    q: 'What makes Genesis Life Care different from other nursing homes near Shah Alam?',
    a: 'Genesis Life Care stands out with our on-site doctor, psychologist-led dementia programmes, professional physiotherapy team, and affordable rates. Our Klang centre has 120+ beds and is rated 4.8 stars on Google with positive reviews from satisfied families.',
  },
];
...
const faqsZh = [
  {
    q: '莎阿南附近有养老院吗？',
    a: '有。Genesis Life Care Klang位于Klang的Amverton Business Centre，经由联邦2号公路，距离莎阿南大约10分钟车程。我们提供24/7护理、失智症计划和中风康复服务。',
  },
  {
    q: '莎阿南附近的老年人护理费用是多少？',
  ...
  {
    q: '莎阿南居民可以获得哪些服务？',
    a: '我们的Klang中心提供老年人护理、失智症和记忆护理、中风康复、姑息治疗、术后恢复和老年人日间护理计划。所有服务都包括现场医生咨询。',
  },
  {
    q: '在承诺之前，我可以参观莎阿南附近的养老院吗？',
    a: '当然可以。我们鼓励家庭预订我们Klang设施的免费参观。您可以看到生活空间、与护理团队见面并提出任何问题——无任何义务。',
  },
  {
    q: '我如何从莎阿南前往Genesis Life Care Klang？',
    a: '我们的Klang中心可经由联邦2号公路（Jalan Klang-Shah Alam）从莎阿南轻松抵达，车程通常约10分钟。中心位于Klang Jalan Istana的Amverton Business Centre。',
  },
  {
    q: 'Genesis Life Care与莎阿南附近的其他养老院有什么不同？',
    a: 'Genesis Life Care以我们的现场医生、心理学家主导的失智症计划、专业物理治疗团队和实惠的收费而脱颖而出。我们的Klang中心拥有120多张床位，在Google上被评为4.8星，深受满意家庭好评。',
  },
];
  ...
  '@graph': [
    {
      ...
      url: `https://genesiscare.com.my${urlPrefix}/elderly-care-in-shah-alam`,
...
// Lives outside src/app so both /elderly-care-in-shah-alam/page.tsx and
// /zh/elderly-care-in-shah-alam/page.tsx can import it — a Next.js route
...
export function ElderlyCareShahAlamContent({ locale = 'en' }: { locale?: 'en' | 'zh' } = {}) {
            ...
            <div>
              <div className="flex items-center gap-3 mb-5">
                <span className="bg-gold text-gray-900 text-xs font-bold tracking-wide px-3 py-1 rounded-full uppercase">
                  <Bilingual en="Near Shah Alam" zh="莎阿南附近" />
                </span>
              ...
              <p className="text-white text-sm font-semibold uppercase tracking-widest mb-2" style={{ color: 'white' }}>
                <Bilingual en="Elderly Care Near Shah Alam" zh="莎阿南附近的老年人护理" />
              </p>
              <h1 className="text-4xl sm:text-5xl font-extrabold leading-[1.1] tracking-tight text-white mb-5" style={{ color: 'white' }}>
                <Bilingual en={<>Professional Elderly Care<br />Near Shah Alam</>} zh={<>专业老年人护理<br />莎阿南附近</>} />
              </h1>
              <p className="text-lg text-white leading-relaxed mb-8 max-w-xl" style={{ color: 'white' }}>
                <Bilingual
                  en={<>Families in Shah Alam trust Genesis Life Care for quality nursing home
                  services. Our Klang centre is just {nearestCentre.distance} away
                  — offering 24/7 nursing, on-site doctor consultations, dementia care,
                  and comprehensive rehabilitation.</>}
                  zh={<>莎阿南的家庭信赖Genesis Life Care提供优质的养老院服务。我们的Klang中心距离仅{nearestCentre.distanceZh}——提供24/7护理、现场医生咨询、失智症护理以及全面的康复服务。</>}
                />
              </p>
            ...
            <div className="relative hidden lg:block">
              <div className="rounded-2xl overflow-hidden shadow-2xl border-4 border-white/20">
                <img
                  ...
                  alt="Genesis Life Care Klang — nearest elderly care to Shah Alam"
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl shadow-lg px-5 py-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500"><Bilingual en="from Shah Alam" zh="距莎阿南" /></p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="text-primary text-sm font-bold uppercase tracking-widest mb-2"><Bilingual en="Elderly Care Near Shah Alam" zh="莎阿南附近的老年人护理" /></p>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 leading-tight mb-6">
              <Bilingual en="Quality Nursing Home Services for Shah Alam Families" zh="为莎阿南家庭提供优质养老院服务" />
            </h2>
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <p>
                <Bilingual
                  en={<>Shah Alam is the state capital of Selangor, a well-planned city with a large
                  residential population. As parents and grandparents age, finding reliable and
                  professional elderly care close to home becomes a priority for Shah Alam families.</>}
                  zh="莎阿南是雪兰莪州的首府，是一座规划完善、居民众多的城市。随着父母与祖父母年岁渐长，为莎阿南家庭寻找可靠、专业且贴近家门的老年人护理服务，已成为首要考量。"
                />
              </p>
              <p>
                <Bilingual
                  en={<>Genesis Life Care Klang is the nearest Genesis centre to Shah Alam — located at
                  Amverton Business Centre on Jalan Istana, Klang, just a short drive via Federal
                  Route 2. Our facility provides 24-hour nursing care, weekly on-site doctor
                  ...
                  zh="Genesis Life Care Klang是距离莎阿南最近的Genesis中心——位于Klang Jalan Istana的Amverton Business Centre，经由联邦2号公路即可轻松抵达。我们的设施提供24小时护理服务、每周现场医生诊疗、心理学家主导的失智症护理计划，以及配备物理治疗与职能治疗的完整康复部门。"
                />
              </p>
              <p>
                <Bilingual
                  en={<>Whether your loved one needs long-term residential care, post-surgery recovery, or
                  specialised dementia support, our Klang centre offers a safe and nurturing
                  ...
                  zh={<>无论您的家人需要长期住宿护理、术后康复，或是专业的失智症支持，我们的Klang中心都能提供安全、温馨的环境与实惠的收费。我们在Google上获得{nearestCentre.rating}星评分，来自巴生谷各地家庭的评价达{nearestCentre.reviews}则。</>}
                />
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              <Bilingual en="Elderly Care Services Available Near Shah Alam" zh="莎阿南附近可提供的老年人护理服务" />
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="Comprehensive care services for seniors, all available at our Klang centre." zh="全面的乐龄护理服务，均可在我们的Klang中心获得。" />
            </p>
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900">
              <Bilingual en="Visit Our Klang Centre" zh="参观我们的Klang中心" />
            </h2>
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual
                en={<>Just {nearestCentre.distance} from Shah Alam — our centre at Amverton Business Centre, Klang.</>}
                zh={<>距莎阿南仅{nearestCentre.distanceZh}——我们位于Klang的Amverton Business Centre中心。</>}
              />
            </p>
          </div>
              ...
              <div className="p-8">
                <div className="flex items-center gap-2 mb-3">
                  <span className="bg-gold text-gray-900 text-xs font-bold px-3 py-1 rounded-full">
                    <Bilingual en="Klang Centre" zh="Klang中心" />
                  </span>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-2xl mx-auto">
              <Bilingual en="Common questions about elderly care options near Shah Alam." zh="关于莎阿南附近老年人护理选择的常见问题。" />
            </p>
          </div>
      ...
      <section className="hero-dark relative bg-gradient-to-r from-primary via-primary-800 to-secondary overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 text-center">
          <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4">
            <Bilingual en="Find Quality Elderly Care Near Shah Alam" zh="为莎阿南寻找优质老年人护理" />
          </h2>
          <p className="text-lg text-white mb-8 max-w-2xl mx-auto" style={{ color: 'white' }}>
            <Bilingual
              en="Visit our Klang centre for a free tour. See our care spaces,
            meet the team, and discover why families across Shah Alam trust Genesis Life Care."
              zh="欢迎参观我们的Klang中心，免费导览。看看我们的护理空间，认识我们的团队，了解为何莎阿南各地家庭都信赖Genesis Life Care。"
            />
          </p>
